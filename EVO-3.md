**Статус (2026-08-20):** proposal, не backlog. Модельний контур = Artifact + Capability + Policy + CSU, **не** Core; не Phase C і не негайна черга. План: [`docs/phase-d-plan.md`](docs/phase-d-plan.md). Номери `#48`–`#55` у §11 **не** є `QUEUE.md` (колізія з Phase C). Виконання — лише після явного OPEN Phase D.
