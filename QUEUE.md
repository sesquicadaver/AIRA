...
**Handoff:** Phase X first OPEN `#353` (після `#352` Human copy DONE). Tip: `#342` DONE @ Analyze-379 / RFC-0215; `#343`–`#352` DONE @ Analyze-380…389 / RFC-0227…0235.
                  ...
                  → W1 reuse candidate (#340 DONE @ RFC-0224)
                    → W1 result/verify binding (#341 DONE @ RFC-0225)
                      → W close RFC-0215 (#342 DONE)
                        → Phase X Pack 2 (#343–#352 DONE; first OPEN `#353`)
```
...
**Статус фази:** **IN PROGRESS** @ RFC-0226 reserved (після **QUEUE W closed** @ RFC-0215). `#343`–`#352` DONE; **перший OPEN:** `#353`.
...
| 353 | **OPEN** | Analyze-390 — Help F1 model path | UK/EN offline model path; RFC-0236 | Help green | Compare (#354) |
...
**Перший OPEN:** `#353` (Help F1 model path). Tip: `#352` DONE @ Analyze-389 / RFC-0235.
              ...
              → X2 mock + result (#350 DONE)
                → X2 network/P UX (#351 DONE @ RFC-0234)
                  → X2 copy + IA (#352 DONE @ RFC-0235)
                    → X2 Help F1 (#353 OPEN / first OPEN)
                      → X2 Compare (#354)
                        → X2 data paths (#355)
                          → X2 apply-diff (#356)
                            → X3 M6 (#357)
...
| Pack 2 local multi-model GUI (aira-current 2026-09-13 + M1–M6) | [`docs/phase-x-plan.md`](docs/phase-x-plan.md); `#343`–`#358` **IN PROGRESS**; first OPEN `#353`; RFC-0226 reserved |
