...
| 298 | **OPEN** | Analyze-334 — Identity incomplete-pair fail-closed | mint лише якщо обох файлів немає; partial → error | runtime + тести + RFC-D | Help boundary (#299) |
...
**IN PROGRESS.** `#295`–`#297` **DONE**. First OPEN: **`#298`**. Consolidating RFC-0182 file-free until `#305`.

```text
S0 wiring (#295 DONE)
  → S1 reachability key-bound (#296 DONE @ RFC-0183)
    → S1 model descriptor reopen (#297 DONE @ RFC-0184)
      → S1 identity incomplete-pair (#298 OPEN)
        → S1 Help connect boundary (#299)
