...
| # | Status | Analyze | Атомарний scope | Done when | Не в цьому рядку |
|---|--------|---------|-----------------|-----------|------------------|
| 275 | **DONE** | ~~Analyze-310 — Phase Q wiring~~ | plan + QUEUE `#275`–`#285` + `phase_q_doc`; RFC-0164 reserved; fmt tip | plan IN PROGRESS; `#275`–`#276` DONE @ RFC-0165; first OPEN `#277` | identity (#276) |
...
| 277 | **OPEN** | Analyze-312 — Model light observe | no full weights hash on status refresh; cached ready | runtime + тести + RFC-D | verify context (#278) |
...
**IN PROGRESS.** `#275` **DONE**. First OPEN: **`#276`** (first OPEN `#277`). Consolidating RFC-0164 file-free until `#285`.

```text
Q0 wiring (#275 DONE)
  → Q1 unique identity (#276 DONE @ RFC-0165)
    → Q1 model light observe (#277)
