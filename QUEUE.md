...
**IN PROGRESS.** `#266`–`#271` **DONE**. First OPEN: **`#272`**. Consolidating RFC-0156 file-free until `#274`.
...
| Runtime-honest Desktop (post-O audit) | [`docs/phase-p-plan.md`](docs/phase-p-plan.md); `aira-current.md` @ `700ffd5`; `#266`–`#274` (**`#266`–`#271` DONE** @ RFC-0161; first OPEN `#272`; RFC-0156 reserved) |
