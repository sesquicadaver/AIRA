...
| 315 | **OPEN** | Analyze-351 — Result-by-problem authority | problem_id → ArtifactStore verify; index locator | runtime + тести + RFC-D | identity (#316) |
...
**IN PROGRESS.** `#313`–`#314` **DONE**. First OPEN: **`#315`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.

```text
U0 wiring (#313 DONE)
  → U1 verify capsule-sourced (#314 DONE @ RFC-0199)
    → U1 result authority (#315)
      → U1 CLI identity (#316)
