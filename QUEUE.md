...
| Активна черга | Phase W [`docs/phase-w-plan.md`](docs/phase-w-plan.md) `#331`–`#336` **DONE**; first OPEN `#337`; Phase X Pack 2 **QUEUED** `#343`–`#358` |
...
**Перший OPEN:** `#337` (Production activation trust). Tip: `#336` DONE @ Analyze-373 / RFC-0220.  
      ...
      → W1 constraints enforce-or-reject (#334 DONE @ RFC-0218)
        → W1 admission boundary (#335 DONE @ RFC-0219)
          → W1 activate evidence (#336 DONE @ RFC-0220)
            → W1 production trust (#337 OPEN / first OPEN)
...
| Pack 1 residual honesty (post-V audit) | [`docs/phase-w-plan.md`](docs/phase-w-plan.md); `#331`–`#342` **IN PROGRESS**; first OPEN `#337` |
