...
| Активна черга | Phase W [`docs/phase-w-plan.md`](docs/phase-w-plan.md) `#331`–`#337` **DONE**; first OPEN `#338`; Phase X Pack 2 **QUEUED** `#343`–`#358` |
...
**Перший OPEN:** `#338` (Safe weights materialization). Tip: `#337` DONE @ Analyze-374 / RFC-0221.  
        ...
        → W1 admission boundary (#335 DONE @ RFC-0219)
          → W1 activate evidence (#336 DONE @ RFC-0220)
            → W1 production trust (#337 DONE @ RFC-0221)
              → W1 safe materialize (#338 OPEN / first OPEN)
...
| Pack 1 residual honesty (post-V audit) | [`docs/phase-w-plan.md`](docs/phase-w-plan.md); `#331`–`#342` **IN PROGRESS**; first OPEN `#338` |
