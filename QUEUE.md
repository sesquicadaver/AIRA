...
| Активна черга | Audit gate K [`docs/audit-6007442-plan.md`](docs/audit-6007442-plan.md) `#377`–`#382` **OPEN**; перший рядок `#377`. `#376` **DONE**. Phase Y `#359`–`#363` **DONE**; `#364`–`#375` **OPEN** але **після K**. Phase X `#343`–`#358` **DONE** @ RFC-0226; **QUEUE X closed** |
...
**Перший OPEN зараз — `#377` (K2a), не `#364`.** `#376` **DONE**. `#364`–`#375` стартують лише після `#382` DONE. Не Pack 3.
...
**Перший OPEN: `#377` (K2a).** `#376` **DONE**. `#364`–`#375` і `#383`–`#389` не стартують раніше свого місця в дереві.
...
| Повний аудит `6007442` (2026-09-23): K1–K5 + D + acceptance | [`docs/audit-6007442-plan.md`](docs/audit-6007442-plan.md); `#376` **DONE**; `#377`–`#382` **OPEN** (перед `#364`); `#383`–`#389` після `#375`; перший `#377` |
