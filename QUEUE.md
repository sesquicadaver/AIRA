...
| Активна черга | Phase Y [`docs/phase-y-plan.md`](docs/phase-y-plan.md) `#367` **OPEN**; перший рядок `#367`. `#359`–`#366` **DONE**; Audit gate K `#376`–`#382` **DONE**. `#368`–`#375` **OPEN**. Phase X `#343`–`#358` **DONE** @ RFC-0226; **QUEUE X closed** |
...
**Перший OPEN зараз — `#367`.** `#359`–`#366` **DONE**. Audit gate K `#376`–`#382` **DONE**. Не Pack 3.
...
| 367 | **OPEN** | — | Наскрізний тест: A типова → B зі списку → підготовка → запуск → A типова (+ негативи K3–K5) | тест включає помилку підготовки і повтор | метадані |
...
**Перший OPEN: `#367`.** `#359`–`#366` **DONE**. Audit gate K `#376`–`#382` **DONE**. `#368`–`#375` і `#383`–`#389` не стартують раніше свого місця в дереві.
                ...
                → #364 no first-row bind (DONE)
                  → #365 refresh states (DONE)
                    → #366 one endpoint (DONE)
                      → #367 through-test (+ K3–K5 negatives)
                        → #368 … #375
                          → #383 … #387 (D)
                            → #388 … #389 (A)
```
...
Tip: `#358` DONE @ Analyze-395 / RFC-0226; Pack 2 DONE. Pack 3 лишається окремо і не є `#359`. Phase Y `#359`–`#366` DONE; audit gate K `#376`–`#382` **DONE**; перший OPEN `#367`.
...
| Вибір моделі (підтверджений аудит `9f3e642` + `aira-current.md` 2026-09-20) | [`docs/phase-y-plan.md`](docs/phase-y-plan.md); `#359`–`#366` **DONE**; `#367`–`#375` **OPEN** |
| Повний аудит `6007442` (2026-09-23): K1–K5 + D + acceptance | [`docs/audit-6007442-plan.md`](docs/audit-6007442-plan.md); K `#376`–`#382` **DONE**; `#367` **OPEN**; `#383`–`#389` після `#375`; перший `#367` |
