...
**Наступне:** Phase S активовано — див. секцію Phase S вище.
...
**Phase S COMPLETE** (`#295`–`#305` **DONE** @ RFC-0182). **QUEUE S closed.** no OPEN S atoms. A next phase is not activated here.
