...
| Активна черга | Phase W [`docs/phase-w-plan.md`](docs/phase-w-plan.md) `#331`–`#333` **DONE**; first OPEN `#334`; Phase X Pack 2 **QUEUED** `#343`–`#358` |
...
**Перший OPEN:** `#334` (Constraints enforce-or-reject). Tip: `#333` DONE @ Analyze-370 / RFC-0217.  
...
W0 wiring + A0 (#331 DONE)
  → W1 math capsule (#332 DONE @ RFC-0216)
    → W1 strict submit (#333 DONE @ RFC-0217)
      → W1 constraints enforce-or-reject (#334 OPEN / first OPEN)
...
| Pack 1 residual honesty (post-V audit) | [`docs/phase-w-plan.md`](docs/phase-w-plan.md); `#331`–`#342` **IN PROGRESS**; first OPEN `#334` |
