...
**Наступне:** Phase N-fix [`docs/phase-n-fix-plan.md`](docs/phase-n-fix-plan.md) — перший OPEN `#252` (після `#251` @ RFC-0143).
...
**Перший OPEN:** `#252` (канон: перший OPEN `#252`). `#248`–`#251` **DONE** @ RFC-0140 / RFC-0141 / RFC-0142 / RFC-0143. `#231`–`#247` **DONE** (QUEUE N closed). RFC-0139 file-free until `#254`.
...
| Phase N semantic honesty / live rendezvous (post-N audit) | [`docs/phase-n-fix-plan.md`](docs/phase-n-fix-plan.md); `#248`–`#251` **DONE** (@ RFC-0140 / RFC-0141 / RFC-0142 / RFC-0143); `#252`–`#254` OPEN; RFC-0139 reserved |
