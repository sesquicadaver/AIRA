...
| # | Status | Analyze | Атомарний scope | Done when | Не в цьому рядку |
|---|--------|---------|-----------------|-----------|------------------|
| 275 | **DONE** | ~~Analyze-310 — Phase Q wiring~~ | plan + QUEUE `#275`–`#285` + `phase_q_doc`; RFC-0164 reserved; fmt tip | plan IN PROGRESS; `#275`–`#279` DONE @ RFC-0168; first OPEN `#280` | identity (#276) |
...
| 280 | **OPEN** | Analyze-315 — Reachability NAT endpoints | dial≠accepted local_addr one challenge | peer + тести + RFC-D | evidence (#281) |
...
**IN PROGRESS.** `#275`–`#279` **DONE** @ RFC-0168. First OPEN: **`#280`**. Consolidating RFC-0164 file-free until `#285`.
