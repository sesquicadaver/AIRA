...
| 287 | **OPEN** | Analyze-323 — Connection next-step CTA | стан → один primary CTA (не лише Refresh) | desktop + тести + RFC-D | promote (#288) |
...
**IN PROGRESS.** `#286` **DONE**. First OPEN: **`#287`**. Consolidating RFC-0174 file-free until `#294`.

```text
R0 wiring (#286 DONE)
  → R1 Connection CTA (#287 OPEN)
    → R2 promote connect controls (#288)
