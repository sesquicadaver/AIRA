...
**Handoff:** Phase X first OPEN `#344` (після `#343` wiring DONE). Tip: `#342` DONE @ Analyze-379 / RFC-0215; `#343` DONE @ Analyze-380.
                  ...
                  → W1 reuse candidate (#340 DONE @ RFC-0224)
                    → W1 result/verify binding (#341 DONE @ RFC-0225)
                      → W close RFC-0215 (#342 DONE)
                        → Phase X Pack 2 (#343 DONE; first OPEN `#344`)
```
...
**Статус фази:** **IN PROGRESS** @ RFC-0226 reserved (після **QUEUE W closed** @ RFC-0215). `#343` DONE; **перший OPEN:** `#344`.
...
| 344 | **OPEN** | Analyze-381 — Per-model inventory lifecycle (M1) | A/B independent; latest ≠ global auth; RFC-0227 | lifecycle green | select API (#345) |
...
**Перший OPEN:** `#344` (Per-model inventory lifecycle). Tip: `#343` DONE @ Analyze-380; QUEUE W closed @ RFC-0215.

```text
X0 wiring (#343 DONE)
  → X1 inventory M1 (#344 OPEN / first OPEN)
    → X1 select API M2 (#345)
...
| Pack 2 local multi-model GUI (aira-current 2026-09-13 + M1–M6) | [`docs/phase-x-plan.md`](docs/phase-x-plan.md); `#343`–`#358` **IN PROGRESS**; first OPEN `#344`; RFC-0226 reserved |
