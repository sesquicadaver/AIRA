...
| # | Status | Analyze | Атомарний scope | Done when | Не в цьому рядку |
|---|--------|---------|-----------------|-----------|------------------|
| 275 | **DONE** | ~~Analyze-310 — Phase Q wiring~~ | plan + QUEUE `#275`–`#285` + `phase_q_doc`; RFC-0164 reserved; fmt tip | plan IN PROGRESS; `#275`–`#278` DONE @ RFC-0167; first OPEN `#279` | identity (#276) |
...
| 279 | **OPEN** | Analyze-314 — Reachability observation independence | bind ≠ external freshness; skew bound | peer + тести + RFC-D | NAT (#280) |
...
**IN PROGRESS.** `#275`–`#278` **DONE** @ RFC-0167. First OPEN: **`#279`**. Consolidating RFC-0164 file-free until `#285`.
  ...
  → Q1 unique identity (#276 DONE @ RFC-0165)
    → Q1 model light observe (#277 DONE @ RFC-0166)
      → Q1 model verify context (#278 DONE @ RFC-0167)
        → Q1 reach observation independence (#279)
          → Q1 reach NAT (#280)
