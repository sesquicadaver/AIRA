...
**Наступне:** Phase O [`docs/phase-o-plan.md`](docs/phase-o-plan.md) `#255`–`#265` **DONE** @ RFC-0146; QUEUE O closed.
...
Наступна feature-фаза — лише за окремим планом розробника (не вигадана в `#265`).
