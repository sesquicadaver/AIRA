...
| Активна черга | Phase Y [`docs/phase-y-plan.md`](docs/phase-y-plan.md) `#363`–`#375` **OPEN**; перший рядок `#363`. `#359`–`#362` **DONE**. Phase X `#343`–`#358` **DONE** @ RFC-0226; **QUEUE X closed** |
...
План: [`docs/phase-y-plan.md`](docs/phase-y-plan.md). Перший OPEN: `#363`. Не Pack 3.
...
**Phase Y OPEN.** `#359`–`#362` **DONE**. Перший рядок `#363`. `#364`–`#375` не стартують раніше.
...
| Вибір моделі (підтверджений аудит `9f3e642` + `aira-current.md` 2026-09-20) | [`docs/phase-y-plan.md`](docs/phase-y-plan.md); `#359`–`#362` **DONE**; `#363`–`#375` **OPEN**; перший `#363` |
