...
| 320 | **OPEN** | Analyze-356 — AddressBook selective rollback | rollback лише власний candidate | runtime + тести + RFC-D | docs (#321) |
...
**IN PROGRESS.** `#313`–`#319` **DONE**. First OPEN: **`#320`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.
        ...
        → U1 policy audit IDs (#317 DONE @ RFC-0202)
          → U1 failed submit durable (#318 DONE @ RFC-0203)
            → U2 executor honesty (#319 DONE @ RFC-0204)
              → U2 AddressBook selective rollback (#320)
