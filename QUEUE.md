...
| 303 | **OPEN** | Analyze-339 — Observe miss off UI-thread | cache miss → background/streaming hash; UI не full `fs::read` weights | runtime + тести + RFC-D | durability (#304) |
...
**IN PROGRESS.** `#295`–`#302` **DONE**. First OPEN: **`#303`**. Consolidating RFC-0182 file-free until `#305`.
