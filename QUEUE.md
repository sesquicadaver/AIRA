...
| Активна черга | Phase W [`docs/phase-w-plan.md`](docs/phase-w-plan.md) `#331`–`#341` **DONE**; first OPEN `#342`; Phase X Pack 2 **QUEUED** `#343`–`#358` |
...
**Перший OPEN:** `#342` (RFC-0215 + close). Tip: `#341` DONE @ Analyze-378 / RFC-0225.  
                ...
                → W1 backend binding (#339 DONE @ RFC-0223)
                  → W1 reuse candidate (#340 DONE @ RFC-0224)
                    → W1 result/verify binding (#341 DONE @ RFC-0225)
                      → W close RFC-0215 (#342 OPEN / first OPEN)
...
| Pack 1 residual honesty (post-V audit) | [`docs/phase-w-plan.md`](docs/phase-w-plan.md); `#331`–`#342` **IN PROGRESS**; first OPEN `#342` |
