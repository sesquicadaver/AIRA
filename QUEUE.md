...
| 271 | **OPEN** | Analyze-306 — EVM/JSON-RPC honesty | https Amoy path; Mock ≠ ledger claim | adapter + docs + тести + RFC-D | lifecycle (#272) |
| 272 | **OPEN** | Analyze-307 — Lifecycle non-blocking | Start/Stop/Quit off update(); refresh gen invalidate | async_jobs + тести + RFC-D | Help (#273) |
...
**IN PROGRESS.** `#266`–`#270` **DONE**. First OPEN: **`#271`**. Consolidating RFC-0156 file-free until `#274`.
...
| Runtime-honest Desktop (post-O audit) | [`docs/phase-p-plan.md`](docs/phase-p-plan.md); `aira-current.md` @ `700ffd5`; `#266`–`#274` (**`#266`–`#270` DONE** @ RFC-0160; first OPEN `#271`; RFC-0156 reserved) |
