...
| 316 | **OPEN** | Analyze-352 — CLI identity create fail-closed | shared create; повторний create = error | runtime + тести + RFC-D | policy (#317) |
...
**IN PROGRESS.** `#313`–`#315` **DONE**. First OPEN: **`#316`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.
