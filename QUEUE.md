...
| 296 | **OPEN** | Analyze-332 — Reachability key-bound admission | same-ID / foreign-key import → reject; verify vs root keyring | runtime + тести + RFC-D | model reopen (#297) |
...
**IN PROGRESS.** `#295` **DONE**. First OPEN: **`#296`**. Consolidating RFC-0182 file-free until `#305`.

```text
S0 wiring (#295 DONE)
  → S1 reachability key-bound (#296 OPEN)
    → S1 model descriptor reopen (#297)
