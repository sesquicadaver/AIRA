...
**Наступне:** Phase N-fix [`docs/phase-n-fix-plan.md`](docs/phase-n-fix-plan.md) — перший OPEN `#251` (після `#250` @ RFC-0142).
...
**Перший OPEN:** `#251` (канон: перший OPEN `#251`). `#248`–`#250` **DONE** @ RFC-0140 / RFC-0141 / RFC-0142. `#231`–`#247` **DONE** (QUEUE N closed). RFC-0139 file-free until `#254`.
...
| Phase N semantic honesty / live rendezvous (post-N audit) | [`docs/phase-n-fix-plan.md`](docs/phase-n-fix-plan.md); `#248`–`#250` **DONE** (@ RFC-0140 / RFC-0141 / RFC-0142); `#251`–`#254` OPEN; RFC-0139 reserved |
