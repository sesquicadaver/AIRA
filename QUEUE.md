...
**IN PROGRESS.** `#255`–`#257` **DONE**. First OPEN: **`#258`**. Consolidating RFC-0146 file-free until `#265`.
...
| Desktop UX contract + contextual Help F1 (post-N-fix) | [`docs/phase-o-plan.md`](docs/phase-o-plan.md); [`docs/desktop-ux.md`](docs/desktop-ux.md); `#255`–`#265` (**`#255`–`#257` DONE**; first OPEN `#258`; RFC-0146 reserved) |
