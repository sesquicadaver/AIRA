...
**Не** GPU marketplace; **не** LLM у `aira-core`; consolidating RFC-0182 у `#305`; **не** reachability key-bound (`#296`) у wiring.
...
| 304 | **DONE** | ~~Analyze-340 — Reachability durability honesty~~ | docs: replay≠state joint atomic; RFC-0191 | `#304` DONE; first OPEN `#305` | RFC close (#305) |
| 305 | **OPEN** | Analyze-341 — RFC-0182 + close | consolidating RFC-0182; QUEUE S closed | RFC-0182; QUEUE S closed | — |

### Наступний цикл (Phase S)

**IN PROGRESS.** `#295`–`#304` **DONE**. First OPEN: **`#305`**. Consolidating RFC-0182 file-free until `#305`.
