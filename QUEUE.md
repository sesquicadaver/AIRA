...
| 315 | **DONE** | ~~Analyze-351 — Result-by-problem authority~~ | problem_id → ArtifactStore verify; index locator; RFC-0200 | `#315` DONE; first OPEN `#317` | identity (#316) |
...
| 317 | **OPEN** | Analyze-353 — Policy audit uniqueness | унікальний ID; same-ID≠hash → conflict | runtime + тести + RFC-D | failed submit (#318) |
...
**IN PROGRESS.** `#313`–`#316` **DONE**. First OPEN: **`#317`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.
