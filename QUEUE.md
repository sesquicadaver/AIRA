...
| 314 | **OPEN** | Analyze-350 — Verification capsule-sourced | action/expression з admitted capsule; підміна output → fail | runtime + тести + RFC-D | result (#315) |
...
**IN PROGRESS.** `#313` **DONE**. First OPEN: **`#314`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.

```text
U0 wiring (#313 DONE)
  → U1 verify capsule-sourced (#314 OPEN)
