...
| 302 | **OPEN** | Analyze-338 — Submit∥Start/Stop admission | взаємне виключення / черга; немає подвійного start() | desktop + тести + RFC-D | observe UI (#303) |
...
**IN PROGRESS.** `#295`–`#301` **DONE**. First OPEN: **`#302`**. Consolidating RFC-0182 file-free until `#305`.
        ...
        → S1 Help connect boundary (#299 DONE @ RFC-0186)
          → S1 opt-in dial/session (#300 DONE @ RFC-0187)
            → S2 CTA Stop→Start (#301 DONE @ RFC-0188)
              → S2 submit∥lifecycle (#302 OPEN)
                → S2 observe off-UI (#303)
