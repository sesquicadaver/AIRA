...
**Handoff:** Phase X first OPEN `#348` (після `#347` CLI parity DONE). Tip: `#342` DONE @ Analyze-379 / RFC-0215; `#343`–`#347` DONE @ Analyze-380…384 / RFC-0227…0230.
                  ...
                  → W1 reuse candidate (#340 DONE @ RFC-0224)
                    → W1 result/verify binding (#341 DONE @ RFC-0225)
                      → W close RFC-0215 (#342 DONE)
                        → Phase X Pack 2 (#343–#347 DONE; first OPEN `#348`)
```
...
**Статус фази:** **IN PROGRESS** @ RFC-0226 reserved (після **QUEUE W closed** @ RFC-0215). `#343`–`#347` DONE; **перший OPEN:** `#348`.
...
| 348 | **OPEN** | Analyze-385 — Settings Models catalog GUI | list/scan/add/select/prepare + ready reason; RFC-0231 | GUI без CLI | Work executor (#349) |
...
**Перший OPEN:** `#348` (Settings Models catalog GUI). Tip: `#347` DONE @ Analyze-384 / RFC-0230.
    ...
    → X1 select API M2 (#345 DONE)
      → X1 profile→snapshot M3 (#346 DONE)
        → X1 CLI parity M4 (#347 DONE)
          → X2 Settings Models (#348 OPEN / first OPEN)
            → X2 Work executor (#349)
              → X2 mock + result (#350)
                → X2 network/P UX (#351)
                  → X2 copy + IA (#352)
                    → X2 Help F1 (#353)
...
| Pack 2 local multi-model GUI (aira-current 2026-09-13 + M1–M6) | [`docs/phase-x-plan.md`](docs/phase-x-plan.md); `#343`–`#358` **IN PROGRESS**; first OPEN `#348`; RFC-0226 reserved |
