...
| 321 | **OPEN** | Analyze-357 — systemd/docs prime-port | runbook + unit pass validate_aira_port | docs + тест | RFC close (#322) |
| 322 | **OPEN** | Analyze-358 — RFC-0198 + close | consolidating RFC-0198; QUEUE U closed | RFC-0198; QUEUE U closed | — |

### Наступний цикл (Phase U)

**IN PROGRESS.** `#313`–`#320` **DONE**. First OPEN: **`#321`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.
