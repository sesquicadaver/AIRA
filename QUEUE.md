...
| Активна черга | Audit D [`docs/audit-6007442-plan.md`](docs/audit-6007442-plan.md) `#387` **OPEN**; перший рядок `#387`. Phase Y `#359`–`#375` **DONE**; K `#376`–`#382` **DONE**; `#383`–`#386` **DONE**. Phase X `#343`–`#358` **DONE** @ RFC-0226; **QUEUE X closed** |
...
**Перший OPEN зараз — `#387`.** Phase Y `#359`–`#375` **DONE**. Audit gate K `#376`–`#382` **DONE**. `#383`–`#386` **DONE**. Не Pack 3.
...
| 387 | OPEN | — | Entry-points і зламані links | одне актуальне «перше OPEN» | масове DONE без E2E |
| 388 | OPEN | — | Installed acceptance на конкретному SHA після `#367`+K | GUI+CLI+HTTP; негативи; SHA/Ollama/digest | Analyze-396 як proof HEAD |
| 389 | OPEN | — | Старі smoke/Analyze-396 — історичні snapshots | явна дата/SHA в шапці evidence | нові продуктові можливості |

### Наступний цикл

**Перший OPEN: `#387`.** Phase Y `#359`–`#375` **DONE**. Audit gate K `#376`–`#382` **DONE**. `#383`–`#386` **DONE**. `#388`–`#389` не стартують раніше свого місця в дереві.
...
Tip: `#358` DONE @ Analyze-395 / RFC-0226; Pack 2 DONE. Pack 3 лишається окремо і не є `#359`. Phase Y `#359`–`#375` DONE; K `#376`–`#382` **DONE**; `#383`–`#386` DONE; перший OPEN `#387` (D).
...
| Повний аудит `6007442` (2026-09-23): K1–K5 + D + acceptance | [`docs/audit-6007442-plan.md`](docs/audit-6007442-plan.md); K `#376`–`#382` **DONE**; Y `#359`–`#375` **DONE**; `#383`–`#386` **DONE**; перший `#387` (D); `#388`–`#389` (A) після D |
