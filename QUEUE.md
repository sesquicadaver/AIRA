...
## Активна черга (лінійна) — Phase U: Cross-path contract honesty (post-T)

План: [`docs/phase-u-plan.md`](docs/phase-u-plan.md). Канон: [`docs/desktop-ux.md`](docs/desktop-ux.md). QUEUE T closed @ RFC-0192.
**Не** GPU marketplace; **не** LLM у `aira-core`; consolidating RFC-0198 у `#322`; **не** Verification capsule (`#314`) у wiring.
...
| 321 | **DONE** | ~~Analyze-357 — systemd/docs prime-port~~ | runbook + unit pass validate_aira_port; RFC-0206 | `#321` DONE; first OPEN `#322` | RFC close (#322) |
| 322 | **OPEN** | Analyze-358 — RFC-0198 + close | consolidating RFC-0198; QUEUE U closed | RFC-0198; QUEUE U closed | — |

### Наступний цикл (Phase U)

**IN PROGRESS.** `#313`–`#321` **DONE**. First OPEN: **`#322`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.
