...
| 300 | **OPEN** | Analyze-336 — Opt-in peer dial / session evidence | явна адреса + dial + confirmed handshake evidence | desktop + тести + RFC-D | CTA Stop (#301) |
...
**IN PROGRESS.** `#295`–`#299` **DONE**. First OPEN: **`#300`**. Consolidating RFC-0182 file-free until `#305`.
    ...
    → S1 model descriptor reopen (#297 DONE @ RFC-0184)
      → S1 identity incomplete-pair (#298 DONE @ RFC-0185)
        → S1 Help connect boundary (#299 DONE @ RFC-0186)
          → S1 opt-in dial/session (#300 OPEN)
            → S2 CTA Stop→Start (#301)
