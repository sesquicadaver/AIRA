...
| # | Status | Analyze | Атомарний scope | Done when | Не в цьому рядку |
|---|--------|---------|-----------------|-----------|------------------|
| 275 | **DONE** | ~~Analyze-310 — Phase Q wiring~~ | plan + QUEUE `#275`–`#285` + `phase_q_doc`; RFC-0164 reserved; fmt tip | plan IN PROGRESS; `#275`–`#277` DONE @ RFC-0166; first OPEN `#278` | identity (#276) |
...
| 278 | **OPEN** | Analyze-313 — Model verify context | root-scoped verify; reopen without test keyring | runtime + тести + RFC-D | reach obs (#279) |
...
**IN PROGRESS.** `#275`–`#277` **DONE** @ RFC-0166. First OPEN: **`#278`**. Consolidating RFC-0164 file-free until `#285`.

```text
Q0 wiring (#275 DONE)
  → Q1 unique identity (#276 DONE @ RFC-0165)
    → Q1 model light observe (#277 DONE @ RFC-0166)
      → Q1 model verify context (#278)
