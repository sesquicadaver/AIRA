...
| 316 | **DONE** | ~~Analyze-352 — CLI identity create fail-closed~~ | shared create; повторний create = error; RFC-0201 | `#316` DONE; first OPEN `#318` | policy (#317) |
...
| 318 | **OPEN** | Analyze-354 — Failed submit durable | Err після accept → durable failure history | runtime + тести + RFC-D | executor (#319) |
...
**IN PROGRESS.** `#313`–`#317` **DONE**. First OPEN: **`#318`**. Consolidating RFC-0198 file-free until `#322`. Cross-path contract honesty.
