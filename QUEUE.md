...
| 299 | **OPEN** | Analyze-335 — Connect Help boundary honesty | Help/CTA EN+UK: setup ≠ remote; loopback ≠ dial | docs + тести + RFC-D | dial path (#300) |
...
**IN PROGRESS.** `#295`–`#298` **DONE**. First OPEN: **`#299`**. Consolidating RFC-0182 file-free until `#305`.
  ...
  → S1 reachability key-bound (#296 DONE @ RFC-0183)
    → S1 model descriptor reopen (#297 DONE @ RFC-0184)
      → S1 identity incomplete-pair (#298 DONE @ RFC-0185)
        → S1 Help connect boundary (#299 OPEN)
          → S1 opt-in dial/session (#300)
