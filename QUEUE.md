...
**Handoff:** Phase X first OPEN `#347` (після `#346` profile snapshot DONE). Tip: `#342` DONE @ Analyze-379 / RFC-0215; `#343`–`#346` DONE @ Analyze-380…383 / RFC-0227…0229.
                  ...
                  → W1 reuse candidate (#340 DONE @ RFC-0224)
                    → W1 result/verify binding (#341 DONE @ RFC-0225)
                      → W close RFC-0215 (#342 DONE)
                        → Phase X Pack 2 (#343–#346 DONE; first OPEN `#347`)
```
...
**Статус фази:** **IN PROGRESS** @ RFC-0226 reserved (після **QUEUE W closed** @ RFC-0215). `#343`–`#346` DONE; **перший OPEN:** `#347`.
...
**Перший OPEN:** `#347` (CLI supported-contract parity). Tip: `#346` DONE @ Analyze-383 / RFC-0229.
  ...
  → X1 inventory M1 (#344 DONE)
    → X1 select API M2 (#345 DONE)
      → X1 profile→snapshot M3 (#346 DONE)
        → X1 CLI parity M4 (#347 OPEN / first OPEN)
...
| Pack 2 local multi-model GUI (aira-current 2026-09-13 + M1–M6) | [`docs/phase-x-plan.md`](docs/phase-x-plan.md); `#343`–`#358` **IN PROGRESS**; first OPEN `#347`; RFC-0226 reserved |
