...
| 301 | **OPEN** | Analyze-337 — CTA Stop→Start matrix | stopped runtime → Start (не Refresh-only) | desktop + тести + RFC-D | submit gate (#302) |
...
**IN PROGRESS.** `#295`–`#300` **DONE**. First OPEN: **`#301`**. Consolidating RFC-0182 file-free until `#305`.
      ...
      → S1 identity incomplete-pair (#298 DONE @ RFC-0185)
        → S1 Help connect boundary (#299 DONE @ RFC-0186)
          → S1 opt-in dial/session (#300 DONE @ RFC-0187)
            → S2 CTA Stop→Start (#301 OPEN)
              → S2 submit∥lifecycle (#302)
