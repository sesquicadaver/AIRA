...
**IN PROGRESS.** `#286`–`#288` **DONE**. First OPEN: **`#289`**. Consolidating RFC-0174 file-free until `#294`.

```text
R0 wiring (#286 DONE)
  → R1 Connection CTA (#287 DONE @ RFC-0175)
    → R2 promote connect controls (#288 DONE @ RFC-0176)
      → R3 human-primary language (#289 OPEN)
