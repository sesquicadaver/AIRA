...
| # | Status | Analyze | Атомарний scope | Done when | Не в цьому рядку |
|---|--------|---------|-----------------|-----------|------------------|
| 275 | **DONE** | ~~Analyze-310 — Phase Q wiring~~ | plan + QUEUE `#275`–`#285` + `phase_q_doc`; RFC-0164 reserved; fmt tip | plan IN PROGRESS; `#275`–`#282` DONE @ RFC-0171; first OPEN `#283` | identity (#276) |
...
| 283 | **OPEN** | Analyze-318 — Backend≠model used | used model ≠ backend id; undefined without evidence | execution/desktop + тести + RFC-D | invite (#284) |
...
**IN PROGRESS.** `#275`–`#282` **DONE** @ RFC-0171. First OPEN: **`#283`**. Consolidating RFC-0164 file-free until `#285`.
