...
**Статус:** **IN PROGRESS** (активовано 2026-09-10; `#323`–`#326` **DONE**; first OPEN `#327`).  
  ...
  → #324 V1 admission snapshot DONE @ RFC-0209
    → #325 V1 submit constraints API DONE @ RFC-0210
      → #326 V1 reuse after constraints DONE @ RFC-0211
        → #327 V1 activate hash continuity (first OPEN)
...
QUEUE U closed @ RFC-0198
  ...
  → wiring `#323` DONE; `#324`–`#326` DONE @ RFC-0209/0210/0211; план IN PROGRESS; first OPEN `#327`.
```
