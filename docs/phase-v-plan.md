...
**Статус:** **IN PROGRESS** (активовано 2026-09-10; `#323`–`#325` **DONE**; first OPEN `#326`).  
...
#323 V0 wiring (DONE)
  → #324 V1 admission snapshot DONE @ RFC-0209
    → #325 V1 submit constraints API DONE @ RFC-0210
      → #326 V1 reuse after constraints (first OPEN)
...
QUEUE U closed @ RFC-0198
  ...
  → wiring `#323` DONE; `#324`–`#325` DONE @ RFC-0209/0210; план IN PROGRESS; first OPEN `#326`.
```
