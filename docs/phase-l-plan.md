...
| `#219` | L2 | Child env whitelist | `env_clear` + minimal PATH/HOME/LANG; no `AIRA_HTTP_TOKEN` leak **DONE** (RFC-0113) | bounded IO (#220) |
...
#217 wiring DONE; `#218` Activate evidence DONE (RFC-0112); `#219` Child env DONE (RFC-0113); `#220` Bounded pipes DONE (RFC-0114); `#221` ProblemRecord split DONE (RFC-0115); `#222`–`#223` OPEN.
