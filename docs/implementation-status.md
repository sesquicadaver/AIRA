...
**Phase T `#306`–`#312` IN PROGRESS** [`phase-t-plan.md`](phase-t-plan.md) — `#306`–`#309` DONE (wiring / dial / observe fail); first OPEN `#310`; consolidating RFC-0192 file-free until `#312`.
...
| #310 | Quit∥Submit completion | deferred quit or reject sticky flag | **OPEN** |
