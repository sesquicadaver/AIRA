...
**Phase R `#286`–`#294` IN PROGRESS** (`#286`–`#287` DONE; first OPEN `#288`; RFC-0174 reserved file-free): [`phase-r-plan.md`](phase-r-plan.md); living smoke `phase_r_doc.rs`; Analyze-322; `#287` Analyze-323 @ RFC-0175.
...
| #288 | Promote connect controls | invite/profile visible | **OPEN** |
