...
**Phase V `#323`–`#330` IN PROGRESS** @ [`phase-v-plan.md`](phase-v-plan.md) — Repair Pack 1 admission integrity; RFC-0208 reserved; `#323`–`#324` DONE @ RFC-0209; first OPEN `#325`; living smoke `phase_v_doc.rs`.
...
## Phase V gates (**IN PROGRESS**; RFC-0208 reserved)
...
| #325 | Submit API carries constraints | HTTP/CLI/Desktop; RFC-0210 | **OPEN** |
| #326 | Reuse after constraints | reuse key ⊇ snapshot; RFC-0211 | **OPEN** |
| #327 | activate_verified hash continuity | verify→activate; RFC-0212 | **OPEN** |
| #328 | Capsule↔Output↔Result binding | executor facts; RFC-0213 | **OPEN** |
| #329 | E2E fail-closed tests | repair §6 subset; RFC-0214 | **OPEN** |
| #330 | RFC-0208 + close | consolidating; QUEUE V closed | **OPEN** |
