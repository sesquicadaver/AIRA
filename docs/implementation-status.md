...
**Phase N `#231`–`#247` DONE** @ RFC-0123 (local reference; global live rendezvous **PARTIAL**): [`phase-n-plan.md`](phase-n-plan.md); QUEUE N closed; gaps → [`phase-n-fix-plan.md`](phase-n-fix-plan.md) `#248`–`#254`.
...
**Phase N-fix `#248`–`#254` IN PROGRESS** (post-N audit honesty): `#248`–`#251` **DONE** @ RFC-0140 / RFC-0141 / RFC-0142 / RFC-0143; first OPEN `#252`; [`phase-n-fix-plan.md`](phase-n-fix-plan.md); consolidating RFC-0139 at `#254`.

## Phase N-fix gates (IN PROGRESS)
...
| #252 | netns NAT/firewall tests | honest inbound-block tests | OPEN |
| #251 | Expiry before promote | fail-closed expired Presence | OPEN |
| #252 | netns NAT/firewall tests | ns ≠ non-listening loopback | OPEN |
