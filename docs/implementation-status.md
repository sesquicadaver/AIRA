...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#241` **DONE** @ RFC-0124…0133; first OPEN `#242`; consolidating RFC-0123 at `#247`.
...
| #241 | Relay integration | direct→NAT→relay; RFC-0133 | **DONE** @ this PR |
| #242 | Presence refresh | sequence++ / expire | OPEN |
