...
**Phase P `#266`–`#274` IN PROGRESS** (`#266`–`#269` DONE @ RFC-0159; first OPEN `#270`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
