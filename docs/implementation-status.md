...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#284` DONE @ RFC-0173; first OPEN `#285`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.

## Phase Q gates (**IN PROGRESS**; RFC-0164 at `#285`)
...
| #285 | RFC-0164 + close | consolidating; QUEUE Q closed | **OPEN** |
