...
**Phase W `#331`–`#342` IN PROGRESS** @ [`phase-w-plan.md`](phase-w-plan.md) — Pack 1 residual honesty (audit D1–D6); RFC-0215 reserved; `#331`–`#332` DONE @ RFC-0216; first OPEN `#333`; living smoke `phase_w_doc.rs`; handoff Pack 2 → [`phase-x-plan.md`](phase-x-plan.md).
...
| #333 | Strict submit decoding | unknown fields 4xx; RFC-0217 | **OPEN** |
