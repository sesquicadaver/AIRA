...
Model layer (EVO-3): D0–D4 `#53`–`#64` **DONE**. D5.1–D5.3 `#65`–`#67` **DONE** (ShareOffer + share gate + local publish) @ 0aa78b1. `#68` OPEN. Not Core. Plan: [phase-d-plan.md](phase-d-plan.md) §6b.
