...
Model layer (EVO-3): D0–D4 `#53`–`#64` **DONE**. D5.1–D5.2 `#65`–`#66` **DONE** (ShareOffer schema + share gate) @ 4a7314d. `#67` local publish in flight (RFC-0016). `#68` OPEN. Not Core. Plan: [phase-d-plan.md](phase-d-plan.md) §6b.
