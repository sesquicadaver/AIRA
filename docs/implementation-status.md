...
| Operational pipeline PS → Interpret → Reduce → Materialize → Verify → VRA | Book 0 §4; B0-003 | `aira_flow::OperationalPlane` (C1 **reference/demo**) | see **C1 three statuses** below | **DONE** | Do not collapse Executed / VRA fixture / OP-001 (`#384`) |
| **C1 Executed** (process smoke) | RFC-0242; B0-003 smoke | ProcessBackend host process | `c1.pipeline.process_executor_executed` | **DONE** | **Executed ≠ VERIFIED**; not OP-001; not runtime VRA |
| **VRA schema fixture** | Book I §17; B1-010 | `schemas/result/verified-result-artifact.schema.json` | `c1.result.verified_completeness` | **DONE** | Fixture completeness ≠ generate-local VRA pipeline |
| **OP-001** (legacy math) | Conformance OP-001; RFC-0242 | `execution-basic` / historical Calculate 2+2 | historical `c1.pipeline.calculate_2_plus_2` (non-normative) | **LEGACY** | Not normative C1; not Desktop calculator GUI (`#384`) |
...
| Verified Result completeness | Book I §17; B1-010 | `schemas/result/verified-result-artifact.schema.json`; verification-basic + plane | `c1.result.verified_completeness` (fixture); `c1.result.extended_fields` (#126); `verified_result_body_has_b1_010_required_keys`; `missing_vra_required` | **DONE** | `#202` / RFC-0098; RFC-0242: C1 completeness from fixtures, not mandatory math `result=4` |
...
| LLM Execution CSU (local generate) | Book I §2; Phase K `#211`–`#216` | `csu/execution-llm`; `csu/reduction-basic` catalog; `aira-flow` plane; Desktop Work `POST /v1/problems` | `inactive_model_is_capsule_failed`; `missing_process_binary_is_capsule_failed`; `mock_backend_completes_valid_generate_local`; `default_plane_keeps_mock_backend`; `generate_without_activate_is_capsule_failed`; `non_math_prompt_completes_via_execution_llm_mock`; `calculate_two_plus_two_stays_execution_basic` (legacy path); `c1.pipeline.process_executor_executed`; Work host LLM gate (`mock_settings_block_even_math_text`); `per_request_host_cli_model_rewrites_ollama_argv`; `required_host_ollama_a_then_b_admit_distinct_host_cli`; `tampered_pointer_host_ollama_model_is_fail_closed`; `file_weight_binding_on_ollama_backend_is_fail_closed`; `readiness_uses_system_layout_settings_not_data_root_file`; `model_ref_forces_generate_over_math_echo_upper`; `concurrent_materialize_unique_temps_publish_safely`; `work_blocked_during_catalog_mutate`; `list_ollama_models_timeout_fail_closed`; `timed_out_submit_classifies_to_work_timed_out`; `select_host_ollama_skips_activate_verified`; opt-in `installed_product_two_real_ollama_models` (`#[ignore]`, not default CI) | **PARTIAL** | Phase K **DONE** @ RFC-0104. RFC-0242/0243 + re-audit R1–R6 + P2 jobs/Stop/Compare + P3 catalog-by-source. P4: M6 fixtures ≠ installed-product; `#388` Analyze-397 @ `3dbcd84` SHA+digest evidence; `#389` Analyze-396 historical @ `7bb6716` (not HEAD); C1 process-smoke Executed ≠ VRA schema fixture ≠ runtime VRA |
...
| Epistemic CSU | EPI-001; Book III §16; Book IV §13.7 | `csu/epistemic-basic` + plane wiring | `epi_001_…`; `epistemic_assessment_roundtrip_via_plane_and_session`; `calculate_two_plus_two_emits_epistemic_assessment`; historical `c1.pipeline.calculate_2_plus_2` | **PARTIAL** | `#207` / RFC-0103: math Completed writes assessment; RFC-0242 remaps normative C1 |
...
| C1 | Local operational node | `run_c1` | `c1.pipeline.process_executor_executed` (**Executed**); `c1.result.verified_completeness` (**VRA fixture**); manifests / failure-to-evidence; OP-001 math **not** required | **yes** | **DONE** (RFC-0242 / `#384`: three statuses separate) |
...
| Alpha acceptance | MVP | `run_alpha_acceptance` | init layout, process Executed smoke, failure evidence, C0/C1 (not OP-001 VERIFIED) | crate tests | **DONE** |

C0/C1 are a **minimal** encoding of B0/B1/OP/CSU MUST tests, not a 1:1 clone of every Conformance `B*-*` id. Remaining gaps (B2 network wire; VRA `additionalProperties` extras on the C1 demo body) stay documented here. **`#384`:** C1 Executed, VRA fixture, and OP-001 are three Living Spec statuses — never one mixed “smoke verified pipeline.”
...
**Phase N `#231`–`#247` DONE** @ RFC-0123 (local reference; global live rendezvous **PARTIAL**): [`phase-n-plan.md`](phase-n-plan.md); QUEUE N closed; N-fix closed @ RFC-0139; global live **PARTIAL** — [`phase-n-fix-plan.md`](phase-n-fix-plan.md).
...
| #240 | AddressBook promotion | trust-gated; RFC-0132 | **DONE** |
| #241 | Relay integration | direct→NAT→relay; RFC-0133 | **DONE** |
| #242 | Presence refresh | sequence++; RFC-0134 | **DONE** |
| #243 | CLI | port/reachability/rendezvous; RFC-0135 | **DONE** @ this PR |
| #244 | Desktop UX | Network panel; RFC-0136 | **DONE** @ this PR |
| #245 | Ab ovo integration | zero-knowledge discovery; RFC-0137 | **DONE** @ this PR |
| #246 | NAT/relay integration | dual inbound blocked → relay Noise; RFC-0138 | **DONE** @ this PR |
| #247 | RFC-0123 + close | consolidating RFC; QUEUE N closed | **DONE** @ this PR |

Plan: [`phase-n-plan.md`](phase-n-plan.md). Consolidating RFC: `AIRA-RFC-0123` (id **confirmed free** at `#231`).

**Phase N-fix `#248`–`#254` DONE** @ RFC-0139 (post-N audit honesty; QUEUE N-fix closed; global live **PARTIAL**): [`phase-n-fix-plan.md`](phase-n-fix-plan.md); [`AIRA-RFC-0139`](../specs/rfc/AIRA-RFC-0139-phase-n-fix-honesty-close.md).

## Phase N-fix gates (**DONE** @ RFC-0139)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #248 | Live EVM rendezvous | JSON-RPC publish/query; RFC-0140 | **DONE** |
| #249 | Real ab ovo harness | two-process CI; RFC-0141 | **DONE** @ this PR |
| #250 | Reachability session bind | transcript-bound attestation; RFC-0142 | **DONE** @ this PR |
...
| #253 | `next_candidate_port` wrap | modular ring wrap; RFC-0145 | **DONE** @ this PR |
| #254 | Presence temporal + RFC-0139 | `created_at < expires_at`; QUEUE N-fix closed | **DONE** @ this PR |


**Phase P `#266`–`#274` DONE** @ RFC-0156; QUEUE P closed (living smoke `phase_p_doc.rs`).

**Phase Q `#275`–`#285` DONE** @ RFC-0164; **QUEUE Q closed** (living smoke `phase_q_doc.rs`): [`phase-q-plan.md`](phase-q-plan.md).
...
**Phase W `#331`–`#342` DONE** @ [`phase-w-plan.md`](phase-w-plan.md) / RFC-0215 — Pack 1 residual honesty (audit D1–D6); **QUEUE W closed**; living smoke `phase_w_doc.rs`; handoff Pack 2 → [`phase-x-plan.md`](phase-x-plan.md) `#343` DONE (historical tip was `#344`; current tip is **перший OPEN `#392`** — Phase Z [`phase-z-plan.md`](phase-z-plan.md) / `#390`–`#391` DONE @ `phase_z_doc.rs`).

### Phase Z — Desktop chrome density

| Atom | Scope | Evidence | Status |
|------|-------|----------|--------|
| #390 | Phase Z wiring | plan + QUEUE + `phase_z_doc.rs`; RFC-0244 reserved | **DONE** |
| #391 | Work layout budget | `WORK_EDITOR_DESIRED_ROWS` ≥ 8; answer min height | **DONE** |
| #392 | Remove how-it-works | F1 only | **OPEN** |
| #393–#397 | Copy density + close | see `phase-z-plan.md` | **OPEN** |
...
**Phase V `#323`–`#330` DONE** @ RFC-0208 [`phase-v-plan.md`](phase-v-plan.md) — Repair Pack 1 structural admission integrity; **QUEUE V closed**; living smoke `phase_v_doc.rs`.

**Phase U `#313`–`#322` DONE** @ RFC-0198 [`phase-u-plan.md`](phase-u-plan.md) — **QUEUE U closed**; no OPEN U atoms.

**Phase T `#306`–`#312` DONE** @ RFC-0192 [`phase-t-plan.md`](phase-t-plan.md) — **QUEUE T closed**; no OPEN T atoms.

## Phase W gates (**DONE** @ RFC-0215; **QUEUE W closed**)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #331 | Phase W wiring + A0 | plan + QUEUE + `phase_w_doc.rs`; RFC-0215 reserved | **DONE** |
| #332 | Math capsule fidelity | no default `2+2`; RFC-0216 | **DONE** |
| #333 | Strict submit decoding | unknown fields 4xx; RFC-0217 | **DONE** |
| #334 | Constraints enforce-or-reject | matrix; RFC-0218 | **DONE** |
| #335 | Admission boundary verify | text/hash; RFC-0219 | **DONE** |
| #336 | Activate evidence authority | primary evidence; RFC-0220 | **DONE** |
| #337 | Production activation trust | no implicit test key; RFC-0221 | **DONE** |
| #338 | Safe weights materialization | no-follow/post-copy; RFC-0222 | **DONE** |
| #339 | Backend verified binding | mock≠used-model; RFC-0223 | **DONE** |
| #340 | Reuse candidate independent check | foreign VRA; RFC-0224 | **DONE** |
| #341 | Result/verify task binding | swap refs; RFC-0225 | **DONE** |
| #342 | RFC-0215 + close | consolidating; QUEUE W closed | **DONE** |

## Phase X gates (**DONE** @ RFC-0226; **QUEUE X closed**; після W)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #343 | Phase X wiring | plan + QUEUE + `phase_x_doc.rs`; RFC-0226 reserved | **DONE** |
| #344 | Per-model inventory (M1) | independent A/B; RFC-0227 | **DONE** |
| #345 | Select API Auto/required (M2) | RFC-0228 | **DONE** |
| #346 | Profile → snapshot (M3) | RFC-0229 | **DONE** |
| #347 | CLI contract parity (M4) | RFC-0230 | **DONE** |
| #348 | Settings Models catalog GUI | RFC-0231 | **DONE** |
| #349 | Work executor + readiness | RFC-0232 | **DONE** |
| #350 | Mock honesty + result triple | RFC-0233 | **DONE** |
| #351 | Network/address honesty + P UX | RFC-0234 | **DONE** |
| #352 | Human copy + Settings≠System | RFC-0235 | **DONE** |
| #353 | Help F1 model path | RFC-0236 | **DONE** |
| #354 | Work Compare mode | RFC-0237 | **DONE** |
| #355 | Model data paths (light) | RFC-0238 | **DONE** |
| #356 | Apply-diff honesty | RFC-0239 | **DONE** |
| #357 | Two-model acceptance (M6) | RFC-0240 | **DONE** |
| #358 | RFC-0226 + close | consolidating; QUEUE X closed | **DONE** |

## Phase V gates (**DONE** @ RFC-0208; QUEUE V closed)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #323 | Phase V wiring | plan + QUEUE + `phase_v_doc.rs`; RFC-0208 reserved | **DONE** |
| #324 | Admission snapshot type + persist | immutable snapshot; RFC-0209 | **DONE** |
| #325 | Submit API carries constraints | HTTP/CLI/Desktop; RFC-0210 | **DONE** |
| #326 | Reuse after constraints | reuse key ⊇ snapshot; RFC-0211 | **DONE** |
| #327 | activate_verified hash continuity | verify→activate; RFC-0212 | **DONE** |
| #328 | Capsule↔Output↔Result binding | executor facts; RFC-0213 | **DONE** |
| #329 | E2E fail-closed tests | repair §6 subset; RFC-0214 | **DONE** |
| #330 | RFC-0208 + close | consolidating; QUEUE V closed | **DONE** |

## Phase U gates (**DONE** @ RFC-0198; QUEUE U closed)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #313 | Phase U wiring | plan + QUEUE + `phase_u_doc.rs`; RFC-0198 reserved | **DONE** |
| #314 | Verification capsule-sourced | capsule-sourced; RFC-0199 | **DONE** |
| #315 | Result-by-problem authority | ArtifactStore verify; RFC-0200 | **DONE** |
| #316 | CLI identity create fail-closed | shared create; RFC-0201 | **DONE** |
| #317 | Policy audit uniqueness | unique IDs; RFC-0202 | **DONE** |
| #318 | Failed submit durable | failure history; RFC-0203 | **DONE** |
| #319 | Submit executor honesty | mock/reference label + env bind; RFC-0204 | **DONE** |
| #320 | AddressBook selective rollback | selective candidate; RFC-0205 | **DONE** |
| #321 | systemd/docs prime-port | unit/runbook P_AIRA; RFC-0206 | **DONE** |
| #322 | RFC-0198 + close | consolidating RFC-0198; QUEUE U closed | **DONE** |

## Phase T gates (**DONE** @ RFC-0192; QUEUE T closed)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #306 | Phase T wiring | plan + QUEUE + `phase_t_doc.rs`; RFC-0192 reserved | **DONE** |
| #307 | Dial evidence ≠ live session | history only; RFC-0193 | **DONE** |
| #308 | Opt-in dial off UI-thread | jobs/slot; no UI block_on; RFC-0194 | **DONE** |
| #309 | Observe miss fail durable | Pending/Ready/Failed; no rehash storm; RFC-0195 | **DONE** |
| #310 | Quit∥Submit completion | deferred Stop→Close after submit; RFC-0196 | **DONE** |
| #311 | Dial AddressBook candidate honesty | rollback on fail; RFC-0197 | **DONE** |
| #312 | RFC-0192 + close | consolidating RFC-0192; QUEUE T closed | **DONE** |

## Phase S gates (**DONE** @ RFC-0182; QUEUE S closed)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #295 | Phase S wiring | plan + QUEUE + `phase_s_doc.rs`; RFC-0182 reserved | **DONE** |
| #296 | Reachability key-bound admission | same-ID / foreign-key reject; RFC-0183 | **DONE** |
| #297 | Model descriptor root-scoped verify | cold reopen; RFC-0184 | **DONE** |
| #298 | Identity incomplete-pair fail-closed | partial → error; RFC-0185 | **DONE** |
| #299 | Connect Help boundary honesty | Help/CTA boundary; RFC-0186 | **DONE** |
| #300 | Opt-in peer dial / session evidence | dial evidence; RFC-0187 | **DONE** |
| #301 | CTA Stop→Start matrix | Start not Refresh-only; RFC-0188 | **DONE** |
| #302 | Submit∥Start/Stop admission | mutual exclusion; RFC-0189 | **DONE** |
| #303 | Observe miss off UI-thread | background streaming hash; no full buffer on UI; RFC-0190 | **DONE** |
| #304 | Reachability durability honesty | docs: no joint atomic replay+state; RFC-0191 | **DONE** |
| #305 | RFC-0182 + close | consolidating RFC-0182; QUEUE S closed | **DONE** |

## Phase R gates (**DONE** @ RFC-0174; QUEUE R closed)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #286 | Phase R wiring | plan + QUEUE + `phase_r_doc.rs`; RFC-0174 reserved; fmt | **DONE** |
| #287 | Connection next-step CTA | `connection_cta` + RFC-0175 | **DONE** |
| #288 | Promote connect controls | `ui_connect_primary` + RFC-0176 | **DONE** |
| #289 | Human-primary mesh/strip | `mesh_language` + RFC-0177 | **DONE** |
| #290 | Actionable problem/strip | `problem_action` + RFC-0178 | **DONE** |
| #291 | Help connect scenario | invite→profile→restart + RFC-0179 | **DONE** |
| #292 | UK mesh/discovery parity | i18n + RFC-0180 | **DONE** |
| #293 | Cold-start empty profile | guidance + RFC-0181 | **DONE** |
| #294 | RFC-0174 + close | consolidating RFC-0174; QUEUE R closed | **DONE** |

## Phase Q gates (**DONE** @ RFC-0164; QUEUE Q closed)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #275 | Phase Q wiring | plan + QUEUE + `phase_q_doc.rs`; RFC-0164 reserved; fmt | **DONE** |
| #276 | Unique Desktop identity | install-scoped ID; two-root bootstrap; RFC-0165 | **DONE** |
| #277 | Model light observe | observe-ready cache; admit full-hash; RFC-0166 | **DONE** |
| #278 | Model verify context | root-scoped reopen ready; RFC-0167 | **DONE** |
| #279 | Reachability observation independence | separate clocks; skew; RFC-0168 | **DONE** |
| #280 | Reachability NAT endpoints | dial≠accept local_addr; RFC-0169 | **DONE** |
| #281 | Reachability evidence admission | root/replay/apply-time; RFC-0170 | **DONE** |
| #282 | Lifecycle revision races | Quit-during-Start; Applied snapshot; RFC-0171 | **DONE** |
| #283 | Backend≠model used | used ≠ backend id; RFC-0172 | **DONE** |
| #284 | Invite import atomicity | checks before writes; RFC-0173 | **DONE** |
| #285 | RFC-0164 + close | consolidating; QUEUE Q closed | **DONE** |
...
| #273 | Help F1 routing | search/context/titles; RFC-0163 | **DONE** |
| #274 | RFC-0156 + close | consolidating RFC; QUEUE P closed | **DONE** |


**Phase O `#255`–`#265` DONE** @ RFC-0146; QUEUE O closed: [`phase-o-plan.md`](phase-o-plan.md); canon [`desktop-ux.md`](desktop-ux.md); living smoke `phase_o_doc.rs`.

## Phase O gates (**DONE** @ RFC-0146; QUEUE O closed)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #255 | Phase O wiring | plan + QUEUE + desktop-ux canon + `phase_o_doc.rs` | **DONE** |
| #256 | SystemSnapshot honesty | typed projection; UNKNOWN≠OFFLINE; book≠sessions; RFC-0147 | **DONE** @ this PR |
| #257 | Non-blocking work/refresh | async_jobs; repaint≠data; RFC-0148 | **DONE** @ this PR |
| #258 | Action/error/help IDs | lexicon; UiProblem; RFC-0149 | **DONE** @ this PR |
| #259 | Shell IA | Work / System / Settings + Help·F1 | **DONE** @ RFC-0150 |
| #260 | Work screen | user-language; draft; Ctrl+Enter; provenance | **DONE** @ RFC-0151 |
| #261 | System status screen | Program/Model/Connection/Events | **DONE** @ RFC-0152 |
| #262 | Settings apply lifecycle | Saved≠Applied≠Restart | **DONE** @ RFC-0153 |
| #263 | Offline F1 shell | embed + search + context | **DONE** @ RFC-0154 |
| #264 | Seed help topics | uk/en + link check | **DONE** @ RFC-0155 |
| #265 | RFC-0146 + close | consolidating RFC; QUEUE O closed | **DONE** @ RFC-0146 |
