...
Desktop one-click / GUI: launcher `.desktop` `#77` **DONE**; tray/GUI `#78` **ABSENT**. Settings `#75` + lifecycle `#76` **DONE**. Docs: [desktop-launcher.md](desktop-launcher.md). QUEUE `#78`–`#79` OPEN.
