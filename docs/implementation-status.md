...
**Phase S `#295`–`#305` IN PROGRESS** [`phase-s-plan.md`](phase-s-plan.md) — `#295` DONE (wiring / `phase_s_doc.rs` / Analyze-331); `#296` DONE @ RFC-0183; `#297` DONE @ RFC-0184 (descriptor reopen / Analyze-333); first OPEN `#298`; consolidating RFC-0182 file-free until `#305`.
...
| #298 | Identity incomplete-pair fail-closed | partial files → error | **OPEN** |
