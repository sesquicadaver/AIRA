...
**Phase O `#255`–`#265` IN PROGRESS** (`#255`–`#263` DONE; first OPEN `#264`; RFC-0146 reserved file-free): [`phase-o-plan.md`](phase-o-plan.md); canon [`desktop-ux.md`](desktop-ux.md); living smoke `phase_o_doc.rs`.
...
| #264 | Seed help topics | uk/en + link check | **OPEN** |
