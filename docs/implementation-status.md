...
**Phase M `#224`–`#230` IN PROGRESS** (не змінює anti-mission): Linux OS child sandbox after L; [`phase-m-plan.md`](phase-m-plan.md); `#224` wiring **DONE**; first OPEN `#225`; consolidating RFC-0117 at `#230`.
...
| #225 | Landlock FS | Linux Landlock on ProcessBackend child | OPEN |
