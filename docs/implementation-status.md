...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#282` DONE @ RFC-0171; first OPEN `#283`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #283 | Backend≠model used | used ≠ backend id | **OPEN** |
