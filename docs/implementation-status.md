...
**Phase U `#313`–`#322` IN PROGRESS** [`phase-u-plan.md`](phase-u-plan.md) — `#313`–`#315` DONE (wiring / verify / result authority); first OPEN `#316`; consolidating RFC-0198 file-free until `#322`.
...
| #316 | CLI identity create fail-closed | shared create; no overwrite | **OPEN** |
