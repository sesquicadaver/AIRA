...
**Phase V `#323`–`#330` DONE** @ RFC-0208 [`phase-v-plan.md`](phase-v-plan.md) — Repair Pack 1 admission integrity; **QUEUE V closed**; living smoke `phase_v_doc.rs`.
