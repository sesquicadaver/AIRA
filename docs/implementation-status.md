...
**Phase W `#331`–`#342` IN PROGRESS** @ [`phase-w-plan.md`](phase-w-plan.md) — Pack 1 residual honesty (audit D1–D6); RFC-0215 reserved; `#331`–`#337` DONE @ RFC-0221; first OPEN `#338`; living smoke `phase_w_doc.rs`; handoff Pack 2 → [`phase-x-plan.md`](phase-x-plan.md).
