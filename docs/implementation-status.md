...
**Phase W `#331`–`#342` IN PROGRESS** @ [`phase-w-plan.md`](phase-w-plan.md) — Pack 1 residual honesty (audit D1–D6); RFC-0215 reserved; `#331` DONE; first OPEN `#332`; living smoke `phase_w_doc.rs`.
...
| #332 | Math capsule fidelity | no default `2+2`; RFC-0216 | **OPEN** |
