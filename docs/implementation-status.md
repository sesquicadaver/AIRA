...
**Phase P `#266`–`#274` IN PROGRESS** (`#266`–`#267` DONE @ RFC-0157; first OPEN `#268`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
