...
**Phase V `#323`–`#330` IN PROGRESS** @ [`phase-v-plan.md`](phase-v-plan.md) — Repair Pack 1 admission integrity; RFC-0208 reserved; `#323`–`#329` DONE @ RFC-0214; first OPEN `#330`; living smoke `phase_v_doc.rs`.
