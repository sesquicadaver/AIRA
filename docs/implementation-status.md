...
**Phase N-fix `#248`–`#254` IN PROGRESS** (post-N audit honesty): live EVM / real ab ovo / reachability bind / expiry / netns NAT / port wrap / Presence temporal; [`phase-n-fix-plan.md`](phase-n-fix-plan.md); consolidating RFC-0139 at `#254`.

## Phase N-fix gates (IN PROGRESS)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #248 | Live EVM rendezvous | JSON-RPC publish/query | OPEN |
| #249 | Real ab ovo harness | two-process CI | OPEN |
