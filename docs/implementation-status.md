...
**Phase W `#331`–`#342` IN PROGRESS** @ [`phase-w-plan.md`](phase-w-plan.md) — Pack 1 residual honesty (audit D1–D6); RFC-0215 reserved; `#331`–`#333` DONE @ RFC-0217; first OPEN `#334`; living smoke `phase_w_doc.rs`; handoff Pack 2 → [`phase-x-plan.md`](phase-x-plan.md).
...
| #334 | Constraints enforce-or-reject | matrix; RFC-0218 | **OPEN** |
| #335 | Admission boundary verify | text/hash; RFC-0219 | **OPEN** |
