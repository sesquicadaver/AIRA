...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#279` DONE @ RFC-0168; first OPEN `#280`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #280 | Reachability NAT endpoints | dial≠accepted | **OPEN** |
