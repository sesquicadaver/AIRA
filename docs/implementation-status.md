...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#245` **DONE** @ RFC-0124…0137; first OPEN `#246`; consolidating RFC-0123 at `#247`.
...
| #246 | NAT/relay integration | dual inbound blocked → relay Noise | OPEN |
