...
**Phase L `#217`–`#223` IN PROGRESS** (не змінює anti-mission): Execution-boundary hardening after K; [`phase-l-plan.md`](phase-l-plan.md); `#217` wiring **DONE**; `#218` Activate evidence **DONE** (RFC-0112); first OPEN `#219`; consolidating RFC-0111 at `#223`.
...
| #219 | Child env whitelist | `env_clear`; no `AIRA_HTTP_TOKEN` | OPEN |
| #220 | Bounded pipes | cap during read; overflow fail-closed | OPEN |
| #221 | ProblemRecord split | `execution_artifact_id` persisted | OPEN |
| #222 | `network=none` contract | AIRA-mediated none; not OS sandbox | OPEN |
