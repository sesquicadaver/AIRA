...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275` DONE; first OPEN `#276`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #276 | Unique Desktop identity | install-scoped ID; two-root bootstrap | **OPEN** |
