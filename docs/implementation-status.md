...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343` DONE @ Analyze-380; `#344` DONE @ Analyze-381 / RFC-0227; first OPEN `#345`.
...
| #345 | Select API Auto/required (M2) | RFC-0228 | **OPEN** (first OPEN) |
| #346 | Profile → snapshot (M3) | RFC-0229 | **OPEN** |
| #347 | CLI contract parity (M4) | RFC-0230 | **OPEN** |
| #348 | Settings Models catalog GUI | RFC-0231 | **OPEN** |
| #349 | Work executor + readiness | RFC-0232 | **OPEN** |
