...
**Phase T `#306`–`#312` IN PROGRESS** [`phase-t-plan.md`](phase-t-plan.md) — `#306` DONE (wiring / `phase_t_doc.rs` / Analyze-342); first OPEN `#308`; consolidating RFC-0192 file-free until `#312`.
...
| #308 | Opt-in dial off UI-thread | jobs/slot; no UI block_on | **OPEN** |
