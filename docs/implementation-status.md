...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#281` DONE @ RFC-0170; first OPEN `#282`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #282 | Lifecycle revision races | Quit-during-Start; Applied snapshot | **OPEN** |
