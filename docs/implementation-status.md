...
**Phase O `#255`–`#265` IN PROGRESS** (`#255`–`#263` DONE; first OPEN `#265`; RFC-0146 reserved file-free): [`phase-o-plan.md`](phase-o-plan.md); canon [`desktop-ux.md`](desktop-ux.md); living smoke `phase_o_doc.rs`.

## Phase O gates (**IN PROGRESS**; RFC-0146 at `#265`)
...
| #265 | RFC-0146 + close | consolidating RFC; QUEUE O closed | **OPEN** |
