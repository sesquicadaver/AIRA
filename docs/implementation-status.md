...
**Phase R `#286`–`#294` IN PROGRESS** (`#286` DONE; first OPEN `#287`; RFC-0174 reserved file-free): [`phase-r-plan.md`](phase-r-plan.md); living smoke `phase_r_doc.rs`; Analyze-322.
...
| #287 | Connection next-step CTA | one primary CTA | **OPEN** |
