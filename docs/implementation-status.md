...
**Phase S `#295`–`#305` IN PROGRESS** [`phase-s-plan.md`](phase-s-plan.md) — `#295` DONE (wiring / `phase_s_doc.rs` / Analyze-331); `#296` DONE @ RFC-0183 (key-bound admission / Analyze-332); first OPEN `#297`; consolidating RFC-0182 file-free until `#305`.
...
| #297 | Model descriptor root-scoped verify | cold reopen without global keyring priming | **OPEN** |
