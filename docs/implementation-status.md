...
**Phase L `#217`–`#223` IN PROGRESS** (не змінює anti-mission): Execution-boundary hardening after K; [`phase-l-plan.md`](phase-l-plan.md); `#217` wiring **DONE**; first OPEN `#218`; consolidating RFC-0111 at `#223`.
...
| #218 | Activate evidence | hash + cache bytes + evidence artifact | OPEN |
