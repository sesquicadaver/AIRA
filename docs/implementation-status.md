...
**Phase P `#266`–`#274` IN PROGRESS** (`#266`–`#270` DONE @ RFC-0160; first OPEN `#271`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
