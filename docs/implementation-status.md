...
**Phase W `#331`–`#342` IN PROGRESS** @ [`phase-w-plan.md`](phase-w-plan.md) — Pack 1 residual honesty (audit D1–D6); RFC-0215 reserved; `#331`–`#335` DONE @ RFC-0219; first OPEN `#336`; living smoke `phase_w_doc.rs`; handoff Pack 2 → [`phase-x-plan.md`](phase-x-plan.md).

**Phase X `#343`–`#358` QUEUED** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; **не** first OPEN до QUEUE W closed.
...
## Phase W gates (**IN PROGRESS**; RFC-0215 reserved)
...
| #336 | Activate evidence authority | primary evidence; RFC-0220 | **OPEN** |
| #337 | Production activation trust | no implicit test key; RFC-0221 | **OPEN** |
| #338 | Safe weights materialization | no-follow/post-copy; RFC-0222 | **OPEN** |
| #339 | Backend verified binding | mock≠used-model; RFC-0223 | **OPEN** |
| #340 | Reuse candidate independent check | foreign VRA; RFC-0224 | **OPEN** |
| #341 | Result/verify task binding | swap refs; RFC-0225 | **OPEN** |
| #342 | RFC-0215 + close | consolidating; QUEUE W closed | **OPEN** |

## Phase X gates (**QUEUED**; RFC-0226 reserved; після W)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #343 | Phase X wiring | plan + QUEUE + `phase_x_doc.rs`; RFC-0226 reserved | **OPEN** (QUEUED) |
| #344 | Per-model inventory (M1) | independent A/B; RFC-0227 | **OPEN** (QUEUED) |
| #345 | Select API Auto/required (M2) | RFC-0228 | **OPEN** (QUEUED) |
| #346 | Profile → snapshot (M3) | RFC-0229 | **OPEN** (QUEUED) |
| #347 | CLI contract parity (M4) | RFC-0230 | **OPEN** (QUEUED) |
| #348 | Settings Models catalog GUI | RFC-0231 | **OPEN** (QUEUED) |
| #349 | Work executor + readiness | RFC-0232 | **OPEN** (QUEUED) |
| #350 | Mock honesty + result triple | RFC-0233 | **OPEN** (QUEUED) |
| #351 | Network/address + P UX | RFC-0234 | **OPEN** (QUEUED) |
| #352 | Human copy + Settings≠System | RFC-0235 | **OPEN** (QUEUED) |
| #353 | Help F1 model path | RFC-0236 | **OPEN** (QUEUED) |
| #354 | Work Compare mode | RFC-0237 | **OPEN** (QUEUED) |
| #355 | Model data paths (light) | RFC-0238 | **OPEN** (QUEUED) |
| #356 | Apply-diff honesty | RFC-0239 | **OPEN** (QUEUED) |
| #357 | Two-model acceptance (M6) | RFC-0240 | **OPEN** (QUEUED) |
| #358 | RFC-0226 + close | consolidating; QUEUE X closed | **OPEN** (QUEUED) |
