...
**Phase U `#313`–`#322` IN PROGRESS** [`phase-u-plan.md`](phase-u-plan.md) — `#313`–`#319` DONE (wiring … executor honesty); first OPEN `#320`; consolidating RFC-0198 file-free until `#322`.
