...
**Phase T `#306`–`#312` IN PROGRESS** [`phase-t-plan.md`](phase-t-plan.md) — `#306` DONE (wiring / `phase_t_doc.rs` / Analyze-342); first OPEN `#307`; consolidating RFC-0192 file-free until `#312`.
...
| #307 | Dial evidence ≠ live session | evidence ≠ live_session_count | **OPEN** |
