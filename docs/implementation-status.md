...
**Phase P `#266`–`#274` IN PROGRESS** (`#266`–`#272` DONE @ RFC-0162; first OPEN `#273`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
