...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#280` DONE @ RFC-0169; first OPEN `#281`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #281 | Reachability evidence admission | root/replay/apply-time | **OPEN** |
