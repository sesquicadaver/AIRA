...
**Phase O `#255`–`#265` IN PROGRESS** (Desktop UX + F1; RFC-0146 reserved file-free): [`phase-o-plan.md`](phase-o-plan.md); canon [`desktop-ux.md`](desktop-ux.md); living smoke `phase_o_doc.rs`.
...
| #263 | Offline F1 shell | embed + search + context | **OPEN** |
| #264 | Seed help topics | uk/en catalog | **OPEN** |
