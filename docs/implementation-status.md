...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343`–`#354` DONE @ Analyze-380…391 / RFC-0227…0237; first OPEN `#355`.
...
| #355 | Model data paths (light) | RFC-0238 | **OPEN** (first OPEN) |
