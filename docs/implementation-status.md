...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#277` DONE @ RFC-0166; first OPEN `#278`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #278 | Model verify context | root-scoped reopen ready | **OPEN** |
