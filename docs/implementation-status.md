...
**Phase U `#313`–`#322` IN PROGRESS** [`phase-u-plan.md`](phase-u-plan.md) — `#313`–`#316` DONE (wiring / verify / result / identity create); first OPEN `#317`; consolidating RFC-0198 file-free until `#322`.
...
| #317 | Policy audit uniqueness | unique IDs; persist conflict | **OPEN** |
| #318 | Failed submit durable | failure history after reopen | **OPEN** |
| #319 | Submit executor honesty | mock vs configured explicit | **OPEN** |
| #320 | AddressBook selective rollback | own-entry only | **OPEN** |
