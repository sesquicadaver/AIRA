...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#243` **DONE** @ RFC-0124…0135; first OPEN `#244`; consolidating RFC-0123 at `#247`.
