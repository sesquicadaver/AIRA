...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#276` DONE @ RFC-0165; first OPEN `#277`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #277 | Model light observe | no full weights hash on refresh | **OPEN** |
