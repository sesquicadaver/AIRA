...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#244` **DONE** @ RFC-0124…0136; first OPEN `#245`; consolidating RFC-0123 at `#247`.
