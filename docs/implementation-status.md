...
**Phase N-fix `#248`–`#254` IN PROGRESS** (post-N audit honesty): `#248`–`#250` **DONE** @ RFC-0140 / RFC-0141 / RFC-0142; first OPEN `#251`; [`phase-n-fix-plan.md`](phase-n-fix-plan.md); consolidating RFC-0139 at `#254`.
...
| #251 | Expiry before promote | expired Presence fail-closed | OPEN |
