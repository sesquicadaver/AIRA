...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343`–`#350` DONE @ Analyze-380…387 / RFC-0227…0233; first OPEN `#351`.
...
## Phase X gates (**IN PROGRESS**; RFC-0226 reserved; після W)
...
| #351 | Network/address honesty + P UX | RFC-0234 | **OPEN** (first OPEN) |
| #350 | Mock honesty + result triple | RFC-0233 | **OPEN** |
| #351 | Network/address + P UX | RFC-0234 | **OPEN** |
| #352 | Human copy + Settings≠System | RFC-0235 | **OPEN** |
| #353 | Help F1 model path | RFC-0236 | **OPEN** |
| #354 | Work Compare mode | RFC-0237 | **OPEN** |
| #355 | Model data paths (light) | RFC-0238 | **OPEN** |
| #356 | Apply-diff honesty | RFC-0239 | **OPEN** |
| #357 | Two-model acceptance (M6) | RFC-0240 | **OPEN** |
| #358 | RFC-0226 + close | consolidating; QUEUE X closed | **OPEN** |
