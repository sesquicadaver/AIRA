...
**Phase S `#295`–`#305` IN PROGRESS** [`phase-s-plan.md`](phase-s-plan.md) — `#295` DONE (wiring / `phase_s_doc.rs` / Analyze-331); `#296` DONE @ RFC-0183; `#297` DONE @ RFC-0184; `#298` DONE @ RFC-0185; `#299` DONE @ RFC-0186; `#300` DONE @ RFC-0187; `#301` DONE @ RFC-0188; `#302` DONE @ RFC-0189 (submit∥lifecycle / Analyze-338); first OPEN `#303`; consolidating RFC-0182 file-free until `#305`.
...
| #303 | Observe miss off UI-thread | streaming hash; no full weights read on UI | **OPEN** |
| #304 | Reachability durability honesty | commit boundary or docs | **OPEN** |
