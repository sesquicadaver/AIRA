...
**Phase T `#306`–`#312` IN PROGRESS** [`phase-t-plan.md`](phase-t-plan.md) — `#306`–`#310` DONE (wiring / dial / observe / Quit∥Submit); first OPEN `#311`; consolidating RFC-0192 file-free until `#312`.
...
| #311 | Dial AddressBook candidate honesty | no silent overwrite on fail | **OPEN** |
| #312 | RFC-0192 + close | consolidating; QUEUE T closed | **OPEN** |
