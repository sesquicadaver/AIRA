...
**Phase N-fix `#248`–`#254` IN PROGRESS** (post-N audit honesty): `#248`–`#253` **DONE** @ RFC-0140…RFC-0145; first OPEN `#254`; [`phase-n-fix-plan.md`](phase-n-fix-plan.md); consolidating RFC-0139 at `#254`.
