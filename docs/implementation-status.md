...
**Phase T `#306`–`#312` IN PROGRESS** [`phase-t-plan.md`](phase-t-plan.md) — `#306`–`#308` DONE (wiring / dial honesty / dial off-UI); first OPEN `#309`; consolidating RFC-0192 file-free until `#312`.
...
| #309 | Observe miss fail durable | Pending/Ready/Failed; no rehash storm | **OPEN** |
