...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#283` DONE @ RFC-0172; first OPEN `#284`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #284 | Invite import atomicity | checks before writes | **OPEN** |
