...
| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #255 | Phase O wiring | plan + QUEUE + desktop-ux canon + `phase_o_doc.rs` | **DONE** @ this PR |
| #256 | SystemSnapshot honesty | typed projection; UNKNOWN≠OFFLINE; book≠sessions | **OPEN** |
