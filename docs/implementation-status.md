...
**Phase N `#231`–`#247` DONE** @ RFC-0123 (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#247` **DONE** @ RFC-0123…0138; QUEUE N closed; consolidating RFC-0123 at `#247`.
