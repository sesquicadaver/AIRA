...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343`–`#345` DONE @ Analyze-380…382 / RFC-0227…0228; first OPEN `#346`.
...
| #346 | Profile → snapshot (M3) | RFC-0229 | **OPEN** (first OPEN) |
