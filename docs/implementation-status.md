...
**Phase L `#217`–`#223` IN PROGRESS** (не змінює anti-mission): Execution-boundary hardening after K; [`phase-l-plan.md`](phase-l-plan.md); `#217` wiring **DONE**; `#218` Activate evidence **DONE** (RFC-0112); `#219` Child env whitelist **DONE** (RFC-0113); `#220` Bounded pipes **DONE** (RFC-0114); first OPEN `#221`; consolidating RFC-0111 at `#223`.
