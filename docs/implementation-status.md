...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343`–`#351` DONE @ Analyze-380…388 / RFC-0227…0234; first OPEN `#352`.
...
| #352 | Human copy + Settings≠System | RFC-0235 | **OPEN** (first OPEN) |
