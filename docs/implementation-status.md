...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#235` **DONE** @ RFC-0124/0125/0126/0127; first OPEN `#236`; consolidating RFC-0123 at `#247`.
