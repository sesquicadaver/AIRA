...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343`–`#347` DONE @ Analyze-380…384 / RFC-0227…0230; first OPEN `#348`.
...
| #348 | Settings Models catalog GUI | RFC-0231 | **OPEN** (first OPEN) |
