...
**Phase V `#323`–`#330` IN PROGRESS** @ [`phase-v-plan.md`](phase-v-plan.md) — Repair Pack 1 admission integrity; RFC-0208 reserved; `#323`–`#327` DONE @ RFC-0212; first OPEN `#328`; living smoke `phase_v_doc.rs`.
