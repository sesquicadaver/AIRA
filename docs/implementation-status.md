...
**Phase P `#266`–`#274` IN PROGRESS** (`#266`–`#273` DONE @ RFC-0163; first OPEN `#274`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
