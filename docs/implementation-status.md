...
Model layer (EVO-3): D0–D4 `#53`–`#64` **DONE** on main (schemas → inventory → compatibility → DENY/ALLOW → quarantine → verify → activate). D5–D7 not in QUEUE. Not Core. Plan: [phase-d-plan.md](phase-d-plan.md) §6a.
