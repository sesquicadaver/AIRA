...
**Phase S `#295`–`#305` IN PROGRESS** [`phase-s-plan.md`](phase-s-plan.md) — `#295` DONE (wiring / `phase_s_doc.rs` / Analyze-331); `#296` DONE @ RFC-0183; `#297` DONE @ RFC-0184; `#298` DONE @ RFC-0185 (incomplete-pair / Analyze-334); first OPEN `#299`; consolidating RFC-0182 file-free until `#305`.
...
| #299 | Connect Help boundary honesty | setup ≠ remote; loopback ≠ dial | **OPEN** |
| #300 | Opt-in peer dial / session evidence | explicit address + handshake | **OPEN** |
| #301 | CTA Stop→Start matrix | stopped → Start | **OPEN** |
