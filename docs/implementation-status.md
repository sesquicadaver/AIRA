...
Model layer (EVO-3): D0–D4 `#53`–`#64` **DONE**. Addendum D5 `#65`–`#68` OPEN (ShareOffer → share gate → local publish → local capability ad; no remote market). D6–D7 not in QUEUE. Not Core. Plan: [phase-d-plan.md](phase-d-plan.md) §6b.
