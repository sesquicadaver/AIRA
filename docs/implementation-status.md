...
**Phase N-fix `#248`–`#254` IN PROGRESS** (post-N audit honesty): `#248`–`#252` **DONE** @ RFC-0140…RFC-0144; first OPEN `#253`; [`phase-n-fix-plan.md`](phase-n-fix-plan.md); consolidating RFC-0139 at `#254`.
