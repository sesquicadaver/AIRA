...
**Phase P `#266`–`#274` IN PROGRESS** (`#266`–`#268` DONE @ RFC-0158; first OPEN `#269`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
