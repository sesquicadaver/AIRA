...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231` wiring **DONE**; first OPEN `#232`; consolidating RFC-0123 at `#247`.
...
| #232 | Prime Port invariant | `prime_port`; P_AIRA=1491; fail-closed | OPEN |
| #233 | Deterministic port selection | preferred_port(identity) | OPEN |
| #234 | Presence Record | schema + Ed25519 | OPEN |
| #235 | RendezvousProvider | trait + mock | OPEN |
| #236 | EVM ledger adapter | local double; Amoy/mainnet hooks | OPEN |
| #237 | Publish/query | TTL/sequence | OPEN |
| #238 | Reachability Probe | peer-assisted challenge | OPEN |
| #239 | Reachability states | reachability.json | OPEN |
