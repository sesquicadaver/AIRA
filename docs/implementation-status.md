...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343`–`#346` DONE @ Analyze-380…383 / RFC-0227…0229; first OPEN `#347`.
...
| #347 | CLI contract parity (M4) | RFC-0230 | **OPEN** (first OPEN) |
