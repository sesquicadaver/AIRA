...
**Phase S `#295`–`#305` IN PROGRESS** [`phase-s-plan.md`](phase-s-plan.md) — `#295` DONE (wiring / `phase_s_doc.rs` / Analyze-331); `#296` DONE @ RFC-0183; `#297` DONE @ RFC-0184; `#298` DONE @ RFC-0185; `#299` DONE @ RFC-0186; `#300` DONE @ RFC-0187; `#301` DONE @ RFC-0188 (CTA Stop→Start / Analyze-337); first OPEN `#302`; consolidating RFC-0182 file-free until `#305`.
...
| #302 | Submit∥Start/Stop admission | mutual exclusion | **OPEN** |
