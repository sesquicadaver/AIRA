...
**Phase P `#266`–`#274` IN PROGRESS** (`#266`–`#271` DONE @ RFC-0161; first OPEN `#272`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
