...
**Phase R `#286`–`#294` IN PROGRESS** (`#286`–`#292` DONE; first OPEN `#293`; RFC-0174 reserved file-free): [`phase-r-plan.md`](phase-r-plan.md); living smoke `phase_r_doc.rs`; Analyze-322; `#287` Analyze-323 @ RFC-0175; `#288` Analyze-324 @ RFC-0176; `#289` Analyze-325 @ RFC-0177; `#290` Analyze-326 @ RFC-0178; `#291` Analyze-327 @ RFC-0179; `#292` Analyze-328 @ RFC-0180.
...
| #293 | Cold-start empty profile | guidance without fake Applied | **OPEN** |
