...
**Phase R `#286`–`#294` IN PROGRESS** (`#286`–`#288` DONE; first OPEN `#289`; RFC-0174 reserved file-free): [`phase-r-plan.md`](phase-r-plan.md); living smoke `phase_r_doc.rs`; Analyze-322; `#287` Analyze-323 @ RFC-0175; `#288` Analyze-324 @ RFC-0176.
...
| #289 | Human-primary mesh/strip | human > raw enum | **OPEN** |
