...
**Phase U `#313`–`#322` IN PROGRESS** [`phase-u-plan.md`](phase-u-plan.md) — `#313`–`#321` DONE (wiring … systemd prime-port); first OPEN `#322`; consolidating RFC-0198 file-free until `#322`.

**Phase T `#306`–`#312` DONE** @ RFC-0192 [`phase-t-plan.md`](phase-t-plan.md) — **QUEUE T closed**; no OPEN T atoms.

## Phase U gates (**IN PROGRESS**; RFC-0198 reserved)
...
| #322 | RFC-0198 + close | consolidating; QUEUE U closed | **OPEN** |
