...
**Phase S `#295`–`#305` IN PROGRESS** [`phase-s-plan.md`](phase-s-plan.md) — `#295` DONE (wiring / `phase_s_doc.rs` / Analyze-331); first OPEN `#296`; consolidating RFC-0182 file-free until `#305`.
...
| #296 | Reachability key-bound admission | same-ID / foreign-key reject; RFC-D | **OPEN** |
