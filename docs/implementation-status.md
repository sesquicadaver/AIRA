...
**Phase N-fix `#248`–`#254` IN PROGRESS** (post-N audit honesty): `#248`–`#249` **DONE** @ RFC-0140 / RFC-0141; first OPEN `#250`; [`phase-n-fix-plan.md`](phase-n-fix-plan.md); consolidating RFC-0139 at `#254`.
...
| #250 | Reachability session bind | transcript-bound attestation | OPEN |
