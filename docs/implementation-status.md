...
**Phase N-fix `#248`–`#254` IN PROGRESS** (post-N audit honesty): `#248` **DONE** @ RFC-0140; first OPEN `#249`; [`phase-n-fix-plan.md`](phase-n-fix-plan.md); consolidating RFC-0139 at `#254`.

## Phase N-fix gates (IN PROGRESS)

| ID | Scope | Evidence | Status |
|----|-------|----------|--------|
| #248 | Live EVM rendezvous | JSON-RPC publish/query; RFC-0140 | **DONE** @ this PR |
