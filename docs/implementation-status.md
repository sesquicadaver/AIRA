...
**Phase U `#313`–`#322` IN PROGRESS** [`phase-u-plan.md`](phase-u-plan.md) — `#313` DONE (wiring); first OPEN `#314`; consolidating RFC-0198 file-free until `#322`.
...
| #314 | Verification capsule-sourced | admitted capsule action/expression | **OPEN** |
