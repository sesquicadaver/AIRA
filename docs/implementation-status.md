...
**Phase U `#313`–`#322` IN PROGRESS** [`phase-u-plan.md`](phase-u-plan.md) — `#313`–`#314` DONE (wiring / verify capsule); first OPEN `#315`; consolidating RFC-0198 file-free until `#322`.
...
| #315 | Result-by-problem authority | ArtifactStore verify via problem_id | **OPEN** |
