...
**Phase M `#224`–`#230` IN PROGRESS** (не змінює anti-mission): Linux OS child sandbox after L; [`phase-m-plan.md`](phase-m-plan.md); `#224` wiring **DONE**; `#225` Landlock **DONE**; `#226` seccomp **DONE**; `#227` netns **DONE**; `#228` sandbox-required **DONE**; first OPEN `#229`; consolidating RFC-0117 at `#230`.
