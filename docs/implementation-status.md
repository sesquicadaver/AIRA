...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#242` **DONE** @ RFC-0124…0134; first OPEN `#243`; consolidating RFC-0123 at `#247`.
...
| #242 | Presence refresh | sequence++; RFC-0134 | **DONE** @ this PR |
