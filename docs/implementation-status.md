...
**Phase X `#343`–`#358` IN PROGRESS** @ [`phase-x-plan.md`](phase-x-plan.md) — Pack 2 local multi-model GUI (`aira-current.md` 2026-09-13 + M1–M6); RFC-0226 reserved; `#343` DONE @ Analyze-380 / `phase_x_doc.rs`; first OPEN `#344`.
...
| #344 | Per-model inventory (M1) | independent A/B; RFC-0227 | **OPEN** |
| #345 | Select API Auto/required (M2) | RFC-0228 | **OPEN** |
