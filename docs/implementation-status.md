...
**Phase M `#224`–`#230` IN PROGRESS** (не змінює anti-mission): Linux OS child sandbox after L; [`phase-m-plan.md`](phase-m-plan.md); `#224` wiring **DONE**; `#225` Landlock **DONE**; `#226` seccomp **DONE**; `#227` netns **DONE**; first OPEN `#228`; consolidating RFC-0117 at `#230`.
