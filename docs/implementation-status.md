...
**Phase P `#266`–`#274` IN PROGRESS** (`#266` DONE; first OPEN `#267`; RFC-0156 reserved file-free): [`phase-p-plan.md`](phase-p-plan.md); living smoke `phase_p_doc.rs`.
...
| #267 | Snapshot freshness | Stale; measurement≠load | **OPEN** |
| #268 | Applied from runtime | confirmed runtime / Undefined | **OPEN** |
| #269 | Model triple UX | selected≠ready≠used | **OPEN** |
| #270 | Reachability endpoint bind | endpoint+direction | **OPEN** |
| #271 | EVM/JSON-RPC honesty | Mock ≠ ledger; https path | **OPEN** |
| #272 | Lifecycle non-blocking | Start/Stop off update() | **OPEN** |
| #273 | Help F1 routing | search/context/titles | **OPEN** |
| #274 | RFC-0156 + close | consolidating RFC; QUEUE P closed | **OPEN** |
