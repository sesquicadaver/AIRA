...
| C3 | Local federation + CAP + IO deny + CRP node reject | `run_c3` | **7** cases (#163+#167) incl. `c3.crp.reject_node_route`; optional CI `conformance-c3` (#164, non-gate) | **optional** (`conformance-c3`; not merge gate) | **DONE** (scaffold + `#153` + `#161` + `#163` + `#164` + `#167`) |
