...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#240` **DONE** @ RFC-0124…0132; first OPEN `#241`; consolidating RFC-0123 at `#247`.
...
| #240 | AddressBook promotion | trust-gated; RFC-0132 | **DONE** @ this PR |
| #241 | Relay integration | direct→NAT→relay | OPEN |
