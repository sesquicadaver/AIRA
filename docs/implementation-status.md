...
**Phase Q `#275`–`#285` IN PROGRESS** (`#275`–`#278` DONE @ RFC-0167; first OPEN `#279`; RFC-0164 reserved file-free): [`phase-q-plan.md`](phase-q-plan.md); living smoke `phase_q_doc.rs`.
...
| #279 | Reachability observation independence | bind ≠ external freshness | **OPEN** |
