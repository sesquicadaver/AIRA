...
**Phase N `#231`–`#247` IN PROGRESS** (не змінює anti-mission): Global Node Rendezvous & Prime Connectivity; [`phase-n-plan.md`](phase-n-plan.md); `#231`–`#236` **DONE** @ RFC-0124/0125/0126/0127/0128; first OPEN `#237`; consolidating RFC-0123 at `#247`.
