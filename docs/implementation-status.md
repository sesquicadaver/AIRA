...
**Phase T `#306`–`#312` IN PROGRESS** [`phase-t-plan.md`](phase-t-plan.md) — `#306`–`#311` DONE (wiring / dial / observe / Quit∥Submit / AddressBook); first OPEN `#312`; consolidating RFC-0192 file-free until `#312`.

## Phase T gates (**IN PROGRESS**; RFC-0192 reserved)
...
| #312 | RFC-0192 + close | consolidating RFC-0192; QUEUE T closed | **OPEN** |
