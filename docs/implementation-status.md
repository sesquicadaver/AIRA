...
**Phase V `#323`–`#330` IN PROGRESS** @ [`phase-v-plan.md`](phase-v-plan.md) — Repair Pack 1 admission integrity; RFC-0208 reserved; `#323` DONE; first OPEN `#324`; living smoke `phase_v_doc.rs`.
...
| #324 | Admission snapshot type + persist | immutable snapshot; RFC-0209 | **OPEN** |
