...
Desktop one-click / GUI: `#75`–`#79` **DONE** (Linux E1). Addendum E1.1 P1+QR: `#80`–`#85` OPEN (перший `#80` PeerInvite schema). Docs: [phase-e-plan.md](phase-e-plan.md) §4a, [desktop-packaging.md](desktop-packaging.md).
