...
**Статус:** OPEN (Y tail + D/A). Блок K `#376`–`#382` **DONE**. Перший рядок виконання — `#372`.  
...
**Зв’язок із Phase Y:** `#359`–`#371` **DONE**. K **DONE**. `#372`–`#375` OPEN.  
...
- Не оголошувати Phase Y DONE, доки `#372`–`#375` не закриті (`#367`–`#371` DONE).
