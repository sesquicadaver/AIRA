...
**Статус:** OPEN (Y tail + D/A). Блок K `#376`–`#382` **DONE**. Перший рядок виконання — `#374`.  
...
**Зв’язок із Phase Y:** `#359`–`#373` **DONE**. K **DONE**. `#374`–`#375` OPEN.  
...
- Не оголошувати Phase Y DONE, доки `#374`–`#375` не закриті (`#367`–`#373` DONE).
