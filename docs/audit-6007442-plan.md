...
**Статус:** OPEN (D/A). Блок K `#376`–`#382` **DONE**. Phase Y `#359`–`#375` **DONE**. `#383`–`#384` **DONE**. Перший рядок виконання — `#385`.  
...
**Зв’язок із Phase Y:** `#359`–`#375` **DONE**. K **DONE**. D `#383`–`#384` **DONE**; `#385`–`#387` OPEN.  
