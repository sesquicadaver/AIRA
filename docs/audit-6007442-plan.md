...
**Статус:** OPEN (Y tail + D/A). Блок K `#376`–`#382` **DONE**. Перший рядок виконання — `#373`.  
...
**Зв’язок із Phase Y:** `#359`–`#372` **DONE**. K **DONE**. `#373`–`#375` OPEN.  
...
- Не оголошувати Phase Y DONE, доки `#373`–`#375` не закриті (`#367`–`#372` DONE).
