...
**Статус:** OPEN (Y tail + D/A). Блок K `#376`–`#382` **DONE**. Перший рядок виконання — `#371`.  
...
**Зв’язок із Phase Y:** `#359`–`#370` **DONE**. K **DONE**. `#371`–`#375` OPEN.  
...
- Не оголошувати Phase Y DONE, доки `#371`–`#375` не закриті (`#367`–`#370` DONE).
