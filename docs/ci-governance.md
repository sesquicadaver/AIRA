...
Local federation ceremony (`run_c3`): **8** named cases — federation×4 + CAP + export_deny (#163) + `c3.crp.reject_node_route` (#167) + `c3.crp.route_candidate` (#170). Optional CI job `conformance-c3` (`#164`, non-gate). Next: `run_c4` scaffold `#175`.
...
- Phase H plan (OPEN `#175`): [`phase-h-plan.md`](phase-h-plan.md) — `#174` B2-011 privacy DONE; next `run_c4`
