...
[`phase-i-plan.md`](phase-i-plan.md) → QUEUE `#184`–`#198` (**активна черга**; `#184`–`#185` **DONE**; first OPEN `#186`).
...
`#183` DONE: Phase I активована. Wiring `#184` і status honesty `#185` **DONE**; first OPEN `#186`.
