...
**Статус:** складено 2026-09-07; **IN PROGRESS** — QUEUE `#275`–`#277` **DONE** @ RFC-0166; first OPEN `#278`.  
...
- Per-atom RFC-D: `#276`→**0165** (DONE); `#277`→**0166** (DONE) … `#284`→**0173** (assigned at each atom PR); `#285`→0164 consolidating.
...
`#275`–`#277` DONE @ RFC-0166; first OPEN `#278`.
```
