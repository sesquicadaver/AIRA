...
**Статус:** складено 2026-08-30; **IN PROGRESS** 2026-08-31 → QUEUE `#199` **DONE**; first OPEN `#200`.  
...
1. Лінійність: `#N` після `#N-1`; перший OPEN зараз `#200`.
2. Один атом = один PR.
...
#199 wiring DONE; first OPEN `#200` (Book II ceiling honesty).
