...
Multi-model GUI / Settings catalog / Work «Порівняти» (audit M1–M6) → Phase X [`phase-x-plan.md`](phase-x-plan.md) `#343`–`#358` **IN PROGRESS** (`#343`–`#344` DONE; first OPEN `#345`). Pack 3–7 still separate.
