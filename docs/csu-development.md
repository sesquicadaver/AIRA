...
| execution-llm | `text.generate.local` via bound backend + injected activate gate; MockBackend default on OperationalPlane (`#213`/`#214`); ProcessBackend opt-in (`#215`, not CI) |
