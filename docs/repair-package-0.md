...
Pack 1 admission snapshot — Phase V **IN PROGRESS** ([`phase-v-plan.md`](phase-v-plan.md) / [`repair-package-1.md`](repair-package-1.md); `#323`–`#325` DONE @ RFC-0210; first OPEN `#326`). Pack 2 multi-model GUI; Pack 3–7 still need their own phase plans.
