...
Pack 1 admission snapshot — Phase V **IN PROGRESS** ([`phase-v-plan.md`](phase-v-plan.md) / [`repair-package-1.md`](repair-package-1.md); `#323`–`#324` DONE @ RFC-0209; first OPEN `#325`). Pack 2 multi-model GUI; Pack 3–7 still need their own phase plans.
