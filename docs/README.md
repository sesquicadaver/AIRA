...
| O | [`phase-o-plan.md`](phase-o-plan.md) + [`desktop-ux.md`](desktop-ux.md) | `#255`–`#265` | **IN PROGRESS** (`#255`–`#260` DONE @ RFC-0147…0151; first OPEN `#261`; RFC-0146 reserved) |

## Core reference

| Doc | Topic |
|-----|-------|
| [`implementation-status.md`](implementation-status.md) | Book 0–IV matrix; C0–C5; Phase gates; **Reference v0.3-strict**; QUEUE J closed; QUEUE K closed @ RFC-0104; QUEUE L closed @ RFC-0111; QUEUE M closed @ RFC-0117; QUEUE N closed @ RFC-0123; N-fix `#248`–`#254` DONE; QUEUE N-fix closed; Phase O `#255`–`#260` DONE; first OPEN `#261` (`phase_o_doc.rs`; RFC-0147…0151) |
