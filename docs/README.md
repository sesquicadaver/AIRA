...
**Оновлено:** 2026-09-10. Канон виконання: [`QUEUE.md`](../QUEUE.md) (Phase V [`phase-v-plan.md`](phase-v-plan.md) `#323`–`#324` **DONE** / first OPEN `#325` (Repair Pack 1; RFC-0209; RFC-0208 reserved); Phase U [`phase-u-plan.md`](phase-u-plan.md) `#313`–`#322` **DONE** @ RFC-0198 (**QUEUE U closed**); Phase T [`phase-t-plan.md`](phase-t-plan.md) `#306`–`#312` **DONE** @ RFC-0192 (**QUEUE T closed**); Phase S [`phase-s-plan.md`](phase-s-plan.md) `#295`–`#305` **DONE** @ RFC-0182; **QUEUE S closed**; Phase Q `#275`–`#285` **DONE** @ RFC-0164; **QUEUE Q closed**; Phase R `#286`–`#294` **DONE** @ RFC-0174; **QUEUE R closed**; Phase P `#266`–`#274` **DONE** @ RFC-0156; QUEUE P closed; Phase O `#255`–`#265` **DONE** @ RFC-0146; QUEUE O closed; N-fix `#248`–`#254` **DONE** @ RFC-0139; QUEUE N-fix closed; Phase N `#231`–`#247` **DONE**; QUEUE N closed; Phase M `#224`–`#230` **DONE** @ RFC-0117; QUEUE M closed; Phase L `#217`–`#223` **DONE** @ RFC-0111; QUEUE L closed; Phase K `#209`–`#216` **DONE** @ RFC-0104; QUEUE K closed; Phase J `#199`–`#208` **DONE** @ RFC-0096; QUEUE J closed; Phase I `#184`–`#198` **DONE** @ RFC-0078; QUEUE I closed; Phase H `#152`–`#183` **DONE** @ RFC-0077; Phase G `#120`–`#151` **DONE**). Статус реалізації: [`implementation-status.md`](implementation-status.md) (**Reference v0.3-strict**; [`phase-v-plan.md`](phase-v-plan.md) IN PROGRESS; [`phase-u-plan.md`](phase-u-plan.md) DONE @ RFC-0198; QUEUE U closed; [`phase-s-plan.md`](phase-s-plan.md) DONE @ RFC-0182; QUEUE S closed; [`phase-r-plan.md`](phase-r-plan.md); [`phase-q-plan.md`](phase-q-plan.md); [`phase-o-plan.md`](phase-o-plan.md); [`phase-n-fix-plan.md`](phase-n-fix-plan.md); [`phase-n-plan.md`](phase-n-plan.md); [`phase-m-plan.md`](phase-m-plan.md); [`phase-l-plan.md`](phase-l-plan.md); [`AIRA-RFC-0117`](../specs/rfc/AIRA-RFC-0117-phase-m-os-child-sandbox.md); [`AIRA-RFC-0111`](../specs/rfc/AIRA-RFC-0111-phase-l-execution-boundary.md); [`AIRA-RFC-0104`](../specs/rfc/AIRA-RFC-0104-phase-k-local-llm-csu.md); [`AIRA-RFC-0096`](../specs/rfc/AIRA-RFC-0096-phase-j-book-gap-local.md); [`AIRA-RFC-0078`](../specs/rfc/AIRA-RFC-0078-phase-i-semantic-stabilization.md); [`AIRA-RFC-0077`](../specs/rfc/AIRA-RFC-0077-phase-h-protocol-depth-v0.3.md)).
...
| V | [`phase-v-plan.md`](phase-v-plan.md) + [`repair-package-1.md`](repair-package-1.md) | `#323`–`#330` | **IN PROGRESS** (`#323`–`#324` DONE @ RFC-0209; first OPEN `#325`; RFC-0208 reserved) |

## Core reference

| Doc | Topic |
|-----|-------|
| [`implementation-status.md`](implementation-status.md) | Book 0–IV matrix; C0–C5; Phase gates; **Reference v0.3-strict**; QUEUE J closed; QUEUE K closed @ RFC-0104; QUEUE L closed @ RFC-0111; QUEUE M closed @ RFC-0117; QUEUE N closed @ RFC-0123; N-fix `#248`–`#254` DONE; QUEUE N-fix closed; Phase O `#255`–`#265` DONE @ RFC-0146; QUEUE O closed; Phase P `#266`–`#274` DONE @ RFC-0156; QUEUE P closed; Phase Q `#275`–`#285` DONE @ RFC-0164; QUEUE Q closed; Phase R `#286`–`#294` DONE @ RFC-0174; QUEUE R closed; Phase V [`phase-v-plan.md`](phase-v-plan.md) **IN PROGRESS** (`#323`–`#324` DONE @ RFC-0209; first OPEN `#325`; RFC-0208 reserved; `phase_v_doc.rs`); Phase U [`phase-u-plan.md`](phase-u-plan.md) **DONE** @ RFC-0198 (**QUEUE U closed**); Phase T [`phase-t-plan.md`](phase-t-plan.md) **DONE** @ RFC-0192 (**QUEUE T closed**); Phase S [`phase-s-plan.md`](phase-s-plan.md) **DONE** @ RFC-0182; **QUEUE S closed** ( `phase_s_doc.rs` / `phase_r_doc.rs` / `phase_q_doc.rs`) |
...
| [`repair-package-1.md`](repair-package-1.md) | Pack 1 / Phase V admission integrity (IN PROGRESS; RFC-0208 reserved) |
