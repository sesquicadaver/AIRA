...
| Y | [`phase-y-plan.md`](phase-y-plan.md) | `#359`–`#375` | **OPEN**; `#359`–`#367` DONE; перший `#368` |
| Audit K→A | [`audit-6007442-plan.md`](audit-6007442-plan.md) | `#376`–`#389` | **OPEN**; K `#376`–`#382` **DONE**; перший рядок `#368`; D/A після `#375` |
