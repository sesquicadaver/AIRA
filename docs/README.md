...
| Audit K→A | [`audit-6007442-plan.md`](audit-6007442-plan.md) | `#376`–`#389` | **DONE**; K/D/A closed |
| Z | [`phase-z-plan.md`](phase-z-plan.md) | `#390`–`#397` | **IN PROGRESS**; `#390`–`#391` DONE; **перший OPEN `#392`**; RFC-0244 reserved |
