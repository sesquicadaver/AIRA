...
| N-fix | [`phase-n-fix-plan.md`](phase-n-fix-plan.md) | `#248`–`#254` | **IN PROGRESS** (`#248`–`#250` **DONE** @ RFC-0140 / RFC-0141 / RFC-0142; first OPEN `#251`; RFC-0139 reserved) |

## Core reference

| Doc | Topic |
|-----|-------|
| [`implementation-status.md`](implementation-status.md) | Book 0–IV matrix; C0–C5; Phase gates; **Reference v0.3-strict**; QUEUE J closed; QUEUE K closed @ RFC-0104; QUEUE L closed @ RFC-0111; QUEUE M closed @ RFC-0117; QUEUE N closed @ RFC-0123; N-fix `#248`–`#250` DONE; `#251` OPEN |
