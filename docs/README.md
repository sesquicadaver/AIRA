...
| K | [`phase-k-plan.md`](phase-k-plan.md) | `#209`–`#216` | **IN PROGRESS** (`#209` `#210` `#211` `#212` `#213` `#214` `#215` DONE; first OPEN `#216`) |

## Core reference

| Doc | Topic |
|-----|-------|
| [`implementation-status.md`](implementation-status.md) | Book 0–IV matrix; C0–C5; Phase gates; **Reference v0.3-strict**; QUEUE J closed |
