...
**Оновлено:** 2026-08-28. Канон виконання: [`QUEUE.md`](../QUEUE.md) (Phase H `#157` **OPEN**; `#152`–`#156` **DONE**; Phase G `#120`–`#151` **DONE**). Статус реалізації: [`implementation-status.md`](implementation-status.md) (**Reference v0.2** → ціль Phase H: **v0.3**).
...
| H | [`phase-h-plan.md`](phase-h-plan.md) | `#152`–`#183` | **IN PROGRESS** (`#152`–`#156` DONE; OPEN `#157`) |
