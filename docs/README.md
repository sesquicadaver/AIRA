...
| Q | [`phase-q-plan.md`](phase-q-plan.md) + [`desktop-ux.md`](desktop-ux.md) | `#275`–`#285` | **IN PROGRESS** (`#275`–`#284` DONE @ RFC-0173; first OPEN `#285`; RFC-0164 reserved) |

## Core reference

| Doc | Topic |
|-----|-------|
| [`implementation-status.md`](implementation-status.md) | Book 0–IV matrix; C0–C5; Phase gates; **Reference v0.3-strict**; QUEUE J closed; QUEUE K closed @ RFC-0104; QUEUE L closed @ RFC-0111; QUEUE M closed @ RFC-0117; QUEUE N closed @ RFC-0123; N-fix `#248`–`#254` DONE; QUEUE N-fix closed; Phase O `#255`–`#265` DONE @ RFC-0146; QUEUE O closed; Phase P `#266`–`#274` DONE @ RFC-0156; QUEUE P closed; Phase Q `#275`–`#284` DONE @ RFC-0173; first OPEN `#285` (`phase_p_doc.rs` / `phase_q_doc.rs`; RFC-0164 reserved) |
