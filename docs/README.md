...
| W | [`phase-w-plan.md`](phase-w-plan.md) + [`repair-package-1.md`](repair-package-1.md) | `#331`–`#342` | **DONE** @ RFC-0215 (**QUEUE W closed**; handoff Pack 2 → Phase X `#343`–`#346` DONE; first OPEN `#347`) |
| X | [`phase-x-plan.md`](phase-x-plan.md) | `#343`–`#358` | **IN PROGRESS** (Pack 2 multi-model GUI; `#343`–`#346` DONE; first OPEN `#347`; RFC-0226 reserved; `aira-current.md` 2026-09-13) |
