...
| Y | [`phase-y-plan.md`](phase-y-plan.md) | `#359`–`#375` | **OPEN**; `#359`–`#363` DONE; K DONE; перший `#364` |
| Audit K→A | [`audit-6007442-plan.md`](audit-6007442-plan.md) | `#376`–`#389` | **OPEN**; K `#376`–`#382` **DONE**; перший рядок `#364`; D/A після `#375` |
