...
| T | [`phase-t-plan.md`](phase-t-plan.md) + [`desktop-ux.md`](desktop-ux.md) | `#306`–`#312` | **IN PROGRESS** (`#306`–`#307` DONE @ RFC-0193; first OPEN `#308`; RFC-0192 reserved) |

## Core reference

| Doc | Topic |
|-----|-------|
| [`implementation-status.md`](implementation-status.md) | Book 0–IV matrix; C0–C5; Phase gates; **Reference v0.3-strict**; QUEUE J closed; QUEUE K closed @ RFC-0104; QUEUE L closed @ RFC-0111; QUEUE M closed @ RFC-0117; QUEUE N closed @ RFC-0123; N-fix `#248`–`#254` DONE; QUEUE N-fix closed; Phase O `#255`–`#265` DONE @ RFC-0146; QUEUE O closed; Phase P `#266`–`#274` DONE @ RFC-0156; QUEUE P closed; Phase Q `#275`–`#285` DONE @ RFC-0164; QUEUE Q closed; Phase R `#286`–`#294` DONE @ RFC-0174; QUEUE R closed; Phase T [`phase-t-plan.md`](phase-t-plan.md) **IN PROGRESS** (first OPEN `#308`); Phase S [`phase-s-plan.md`](phase-s-plan.md) **DONE** @ RFC-0182; **QUEUE S closed** ( `phase_s_doc.rs` / `phase_r_doc.rs` / `phase_q_doc.rs`) |
