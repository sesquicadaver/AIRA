...
| C3 | `run_c3` | **7 named local cases**: federation×4 + CAP + export_deny (#163) + `c3.crp.reject_node_route` (#167); depth `#170` | **optional job** `conformance-c3` (#164) — **not** a merge gate ([governance](ci-governance.md#job-conformance-c3-queue-164)) |
