...
Repo-level ТЗ → module → tests map: [implementation-status.md](implementation-status.md) (**Reference v0.3-stable**). Merge gate: [ci-governance.md](ci-governance.md).
...
C4/C5 are local scaffolds only. Research remains **RESEARCH**. Consolidating Phase H RFC: [`AIRA-RFC-0077`](../specs/rfc/AIRA-RFC-0077-phase-h-protocol-depth-v0.3.md). Phase I semantic contracts: [`phase-i-plan.md`](phase-i-plan.md) (`#184`–`#198` **DONE** @ RFC-0078). Phase J Book-gap remainder: [`phase-j-plan.md`](phase-j-plan.md) (`#199` `#200` `#201` `#202` `#203` `#204` `#205` `#206` **DONE**; first OPEN `#207`).
