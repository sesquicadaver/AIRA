...
**Статус:** **IN PROGRESS** (активовано 2026-09-10; wiring `#313` **DONE**; `#314` **DONE** @ RFC-0199; `#315` **DONE** @ RFC-0200; `#316` **DONE** @ RFC-0201; `#317` **DONE** @ RFC-0202; `#318` **DONE** @ RFC-0203; `#319` **DONE** @ RFC-0204; first OPEN `#320`; RFC-0198 reserved file-free).  
        ...
        → #317 U1 policy audit IDs DONE @ RFC-0202
          → #318 U1 failed submit durable DONE @ RFC-0203
            → #319 U2 executor honesty DONE @ RFC-0204
              → #320 U2 AddressBook selective rollback (first OPEN)
