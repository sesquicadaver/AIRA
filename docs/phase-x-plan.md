...
**Статус:** **IN PROGRESS** (активовано `#343` wiring; `#343`–`#353` **DONE**; first OPEN `#354`; RFC-0226 reserved file-free until `#358`).  
...
2. First OPEN репо = `#354` після `#353` Help F1 model path; лінійність `#N` після `#N-1`.
...
QUEUE W closed @ RFC-0215
  ...
  → phase-x-plan **IN PROGRESS**; `#343`–`#353` DONE; first OPEN `#354`.
```
