...
**Статус:** складено 2026-09-06; **IN PROGRESS** → QUEUE `#252`–`#254` (`#248`–`#251` **DONE** @ RFC-0140 / RFC-0141 / RFC-0142 / RFC-0143).  
...
QUEUE N closed @ RFC-0123 + aira-current.md audit 2026-09-06
  → цей план + QUEUE `#248`–`#254` ( `#248`–`#251` DONE; first OPEN `#252` )
