...
**Статус:** складено 2026-09-06; **IN PROGRESS** → QUEUE `#253`–`#254` (`#248`–`#252` **DONE** @ RFC-0140…RFC-0144).  
...
QUEUE N closed @ RFC-0123 + aira-current.md audit 2026-09-06
  → цей план + QUEUE `#248`–`#254` ( `#248`–`#252` DONE; first OPEN `#253` )
