...
**Handoff:** Pack 2 GUI → Phase X [`phase-x-plan.md`](phase-x-plan.md) `#343`–`#358` (**IN PROGRESS**; `#343`–`#345` DONE; first OPEN `#346`; RFC-0226 reserved; джерело GUI `p-only/aira-current.md` 2026-09-13).  
                  ...
                  → #340 W1 reuse candidate DONE @ RFC-0224
                    → #341 W1 result/verify binding DONE @ RFC-0225
                      → #342 W close RFC-0215 DONE
                        → Phase X `#343`–`#345` DONE; first OPEN `#346`
```
...
QUEUE V closed @ RFC-0208
  ...
  → Phase X `#344` inventory DONE @ RFC-0227 (was first OPEN `#344` after wiring); `#345` select DONE @ RFC-0228 (was first OPEN `#345`); first OPEN `#346`.
```
...
Після QUEUE W closed @ RFC-0215:
  ...
  → first OPEN `#346` (Request profile → snapshot)
