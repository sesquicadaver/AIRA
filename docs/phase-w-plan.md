...
**Handoff:** Pack 2 GUI → Phase X [`phase-x-plan.md`](phase-x-plan.md) `#343`–`#358` (**IN PROGRESS**; `#343`–`#348` DONE; first OPEN `#349`; RFC-0226 reserved; джерело GUI `p-only/aira-current.md` 2026-09-13).  
                  ...
                  → #340 W1 reuse candidate DONE @ RFC-0224
                    → #341 W1 result/verify binding DONE @ RFC-0225
                      → #342 W close RFC-0215 DONE
                        → Phase X `#343`–`#348` DONE; first OPEN `#349`
```
...
QUEUE V closed @ RFC-0208
  ...
  → Phase X `#344` inventory DONE @ RFC-0227 (was first OPEN `#344` after wiring); `#345` select DONE @ RFC-0228 (was first OPEN `#345`); `#346` profile DONE @ RFC-0229 (was first OPEN `#346`); `#347` CLI DONE @ RFC-0230 (was first OPEN `#347`); `#348` Settings Models DONE @ RFC-0231 (was first OPEN `#348`); first OPEN `#349`.
```
...
Після QUEUE W closed @ RFC-0215:
  ...
  → `#345` select API DONE @ Analyze-382 / RFC-0228
  ...
  → first OPEN `#349` (Work executor + readiness)
