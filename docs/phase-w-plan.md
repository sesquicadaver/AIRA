...
**Handoff:** Pack 2 GUI → Phase X [`phase-x-plan.md`](phase-x-plan.md) `#343`–`#358` (**IN PROGRESS**; `#343`–`#351` DONE; first OPEN `#352`; RFC-0226 reserved; джерело GUI `p-only/aira-current.md` 2026-09-13).  
                  ...
                  → #340 W1 reuse candidate DONE @ RFC-0224
                    → #341 W1 result/verify binding DONE @ RFC-0225
                      → #342 W close RFC-0215 DONE
                        → Phase X `#343`–`#351` DONE; first OPEN `#352`
```
...
Після QUEUE W closed @ RFC-0215:
  ...
  → first OPEN `#352` (Human copy + Settings≠System IA)
