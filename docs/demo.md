...
**Queue (`#387` / `#389`):** немає OPEN (audit `#376`–`#389` **DONE**) — [`QUEUE.md`](../QUEUE.md) / [`audit-6007442-plan.md`](audit-6007442-plan.md). Do not treat closed Phase G/X tips as current.
