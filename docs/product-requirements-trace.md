...
Pack 1 — admission snapshot + reuse/binding integrity — **IN PROGRESS** as Phase V [`phase-v-plan.md`](phase-v-plan.md) / [`repair-package-1.md`](repair-package-1.md) (`#323`–`#324` DONE @ RFC-0209; first OPEN `#325`; RFC-0208 reserved).  
