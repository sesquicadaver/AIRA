...
Pack 1 — admission snapshot + reuse/binding integrity — **DONE** as Phase V [`phase-v-plan.md`](phase-v-plan.md) / [`repair-package-1.md`](repair-package-1.md) (`#323`–`#330` DONE @ RFC-0208; **QUEUE V closed**).  
