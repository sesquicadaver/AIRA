...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C–E **DONE**. Phase F stabilization **DONE** (`#107`–`#119`, [`docs/phase-f-plan.md`](docs/phase-f-plan.md)). Phase G Reference v0.2 **`#120`–`#151` DONE** — [`docs/phase-g-plan.md`](docs/phase-g-plan.md); consolidating RFC [`AIRA-RFC-0069`](specs/rfc/AIRA-RFC-0069-phase-g-reference-v0.2.md). Phase H Protocol depth v0.3 — [`docs/phase-h-plan.md`](docs/phase-h-plan.md) (`#152`–`#183` **DONE** @ RFC-0077). Phase I semantic contracts — [`docs/phase-i-plan.md`](docs/phase-i-plan.md) (`#184` `#185` `#186` `#187` `#188` `#189` `#190` `#191` `#192` `#193` **DONE**; first OPEN `#194`). Анти-місія §«What AIRA is not» **ніколи** в QUEUE.

Перший OPEN: `#194` (envelope freshness/replay). Status: [`docs/implementation-status.md`](docs/implementation-status.md) (**v0.3**). RFC-P process: [`docs/rfc-p-promotion.md`](docs/rfc-p-promotion.md).
