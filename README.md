...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C–E **DONE**. Phase F stabilization **DONE** (`#107`–`#119`, [`docs/phase-f-plan.md`](docs/phase-f-plan.md)). Phase G Reference v0.2 **`#120`–`#151` DONE** — [`docs/phase-g-plan.md`](docs/phase-g-plan.md); consolidating RFC [`AIRA-RFC-0069`](specs/rfc/AIRA-RFC-0069-phase-g-reference-v0.2.md). Phase H Protocol depth v0.3 — [`docs/phase-h-plan.md`](docs/phase-h-plan.md) (`#152`–`#183` **DONE** @ RFC-0077). Phase I semantic contracts — [`docs/phase-i-plan.md`](docs/phase-i-plan.md) (`#184` `#185` `#186` `#187` `#188` `#189` `#190` `#191` `#192` `#193` `#194` `#195` `#196` `#197` `#198` **DONE** @ RFC-0078). Phase J Book-gap local remainder — [`docs/phase-j-plan.md`](docs/phase-j-plan.md) (`#199` `#200` `#201` `#202` `#203` `#204` `#205` `#206` `#207` `#208` **DONE** @ RFC-0096). Phase K Local LLM Execution CSU — [`docs/phase-k-plan.md`](docs/phase-k-plan.md) (`#209` `#210` `#211` `#212` `#213` `#214` `#215` `#216` **DONE** @ RFC-0104). Phase L Execution-boundary hardening — [`docs/phase-l-plan.md`](docs/phase-l-plan.md) (`#217` `#218` `#219` `#220` `#221` `#222` `#223` **DONE** @ RFC-0111). Phase M OS child sandbox — [`docs/phase-m-plan.md`](docs/phase-m-plan.md) (`#224`–`#230` **DONE** @ RFC-0117). Phase N Global Node Rendezvous — [`docs/phase-n-plan.md`](docs/phase-n-plan.md) (`#231`–`#247` **DONE** @ RFC-0123; QUEUE N closed). Phase N-fix — [`docs/phase-n-fix-plan.md`](docs/phase-n-fix-plan.md) (`#248`–`#254` **DONE** @ RFC-0139; QUEUE N-fix closed). Phase O Desktop UX + F1 — [`docs/phase-o-plan.md`](docs/phase-o-plan.md) (`#255`–`#265` **DONE** @ [`AIRA-RFC-0146`](specs/rfc/AIRA-RFC-0146-phase-o-desktop-ux-help.md); QUEUE O closed). Phase P — [`docs/phase-p-plan.md`](docs/phase-p-plan.md) (`#266`–`#274`; `#266`–`#274` **DONE** @ RFC-0156; QUEUE P closed). Анти-місія §«What AIRA is not» **ніколи** в QUEUE.

Phase J [`docs/phase-j-plan.md`](docs/phase-j-plan.md) **DONE**. Phase K [`docs/phase-k-plan.md`](docs/phase-k-plan.md) **DONE** @ [`AIRA-RFC-0104`](specs/rfc/AIRA-RFC-0104-phase-k-local-llm-csu.md). Phase L [`docs/phase-l-plan.md`](docs/phase-l-plan.md) **DONE** @ [`AIRA-RFC-0111`](specs/rfc/AIRA-RFC-0111-phase-l-execution-boundary.md). Phase M [`docs/phase-m-plan.md`](docs/phase-m-plan.md) **DONE** @ [`AIRA-RFC-0117`](specs/rfc/AIRA-RFC-0117-phase-m-os-child-sandbox.md). Phase N [`docs/phase-n-plan.md`](docs/phase-n-plan.md) **DONE** @ [`AIRA-RFC-0123`](specs/rfc/AIRA-RFC-0123-phase-n-global-rendezvous.md) (`#231`–`#247`; QUEUE N closed). Phase N-fix [`docs/phase-n-fix-plan.md`](docs/phase-n-fix-plan.md) **DONE** @ RFC-0139 (`#248`–`#254`; QUEUE N-fix closed). Phase O [`docs/phase-o-plan.md`](docs/phase-o-plan.md) **DONE** @ RFC-0146 (`#255`–`#265`; QUEUE O closed). Phase P [`docs/phase-p-plan.md`](docs/phase-p-plan.md) **DONE** @ [`AIRA-RFC-0156`](specs/rfc/AIRA-RFC-0156-phase-p-runtime-honest-desktop.md) (`#266`–`#274`; QUEUE P closed). Phase Q [`docs/phase-q-plan.md`](docs/phase-q-plan.md) **DONE** @ [`AIRA-RFC-0164`](specs/rfc/AIRA-RFC-0164-phase-q-cross-install-integrity.md) (`#275`–`#285`; QUEUE Q closed). Phase R [`docs/phase-r-plan.md`](docs/phase-r-plan.md) **DONE** @ [`AIRA-RFC-0174`](specs/rfc/AIRA-RFC-0174-phase-r-actionable-connection-ux.md) (`#286`–`#294`; QUEUE R closed). Phase S [`docs/phase-s-plan.md`](docs/phase-s-plan.md) **DONE** @ [`AIRA-RFC-0182`](specs/rfc/AIRA-RFC-0182-phase-s-cross-boundary-integrity.md) (**QUEUE S closed**). Phase T [`docs/phase-t-plan.md`](docs/phase-t-plan.md) **DONE** @ [`AIRA-RFC-0192`](specs/rfc/AIRA-RFC-0192-phase-t-operation-lifecycle-honesty.md) (**QUEUE T closed**). Phase U [`docs/phase-u-plan.md`](docs/phase-u-plan.md) **DONE** @ [`AIRA-RFC-0198`](specs/rfc/AIRA-RFC-0198-phase-u-cross-path-contract-honesty.md) (`#313`–`#322`; **QUEUE U closed**). Phase V [`docs/phase-v-plan.md`](docs/phase-v-plan.md) **DONE** @ [`AIRA-RFC-0208`](specs/rfc/AIRA-RFC-0208-phase-v-admission-integrity.md) (`#323`–`#330`; **QUEUE V closed**). Phase W [`docs/phase-w-plan.md`](docs/phase-w-plan.md) **IN PROGRESS** (Pack 1 residual honesty; `#331`–`#334` DONE @ RFC-0218; first OPEN `#335`; RFC-0215 reserved). Phase X [`docs/phase-x-plan.md`](docs/phase-x-plan.md) **QUEUED** (Pack 2 GUI; `#343`–`#358`; RFC-0226 reserved; після W). Status: [`docs/implementation-status.md`](docs/implementation-status.md) (**v0.3-strict**). RFC-P process: [`docs/rfc-p-promotion.md`](docs/rfc-p-promotion.md). QUEUE J closed. QUEUE K closed. QUEUE L closed. QUEUE M closed. QUEUE N closed. QUEUE N-fix closed. QUEUE O closed. QUEUE P closed. QUEUE Q closed. QUEUE R closed.
