...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D **#53–#74 DONE**. Phase E **#75–#106 DONE**. Phase F stabilization **#107–#119 DONE** ([`docs/phase-f-plan.md`](docs/phase-f-plan.md)). Phase G Reference v0.2 **#120–#151 OPEN** — [`docs/phase-g-plan.md`](docs/phase-g-plan.md); **перший OPEN = `#129`**.
