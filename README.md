...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase B; наступний OPEN: **#26 Analyze-61** (retention/prune `.prev`).

Останні закриті slices: A-56…A-59; A-60 systemd examples (`deploy/systemd/`, `docs/runbook-systemd.md`).
