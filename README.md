...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D [`docs/phase-d-plan.md`](docs/phase-d-plan.md); **#53–#54 DONE**; наступний OPEN: **#55** (LocalModelInventory payload schema).
