...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D [`docs/phase-d-plan.md`](docs/phase-d-plan.md); **#53–#55 DONE**; наступний OPEN: **#56** (ModelCompatibilityEvidence schema).
