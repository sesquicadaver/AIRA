...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C–E **DONE**. Phase F stabilization **DONE** (`#107`–`#119`, [`docs/phase-f-plan.md`](docs/phase-f-plan.md)). Phase G Reference v0.2 **`#120`–`#151` DONE** — [`docs/phase-g-plan.md`](docs/phase-g-plan.md); consolidating RFC [`AIRA-RFC-0069`](specs/rfc/AIRA-RFC-0069-phase-g-reference-v0.2.md). Phase H Protocol depth v0.3 — [`docs/phase-h-plan.md`](docs/phase-h-plan.md) (`#152`–`#183`, лінійно); `#152`–`#165` **DONE**, **`#166` OPEN**. Анти-місія §«What AIRA is not» **ніколи** в QUEUE.

Активний атом: `#166` (CRP local adapter). Далі: CRP → settlement receipts → research promotion → RFC-0077 / Reference v0.3. Post-H: [`docs/phase-i-plan.md`](docs/phase-i-plan.md) (`#184`–`#198`, **після** `#183`). Status: [`docs/implementation-status.md`](docs/implementation-status.md) (**v0.2**).
