...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D D0–D4 **#53–#64 DONE**; D5.1–D5.2 **#65–#66 DONE**; D5.3 **#67** in flight (local publish); наступний OPEN після merge: **#68**.
