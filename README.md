...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D [`docs/phase-d-plan.md`](docs/phase-d-plan.md); **#53–#56 DONE**; наступний OPEN: **#57** (ModelAcquisitionPolicy schema).
