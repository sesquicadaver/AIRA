...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D D0–D7 **#53–#74 DONE**. Phase E Desktop **#75–#79 OPEN** (Linux P0) — [`docs/desktop-ux.md`](docs/desktop-ux.md), [`docs/phase-e-plan.md`](docs/phase-e-plan.md).
