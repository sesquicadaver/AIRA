...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D D0–D3 **#53–#60 DONE**; Addendum D4 [`docs/phase-d-plan.md`](docs/phase-d-plan.md) §6a — наступний OPEN: **#61** (policy ALLOW path).
