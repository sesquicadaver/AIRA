...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase B **#18–#37 DONE**; Phase C план [`docs/phase-c-plan.md`](docs/phase-c-plan.md); **#38 DONE**; наступний OPEN: **#39** (canonical descriptor hash helper).
