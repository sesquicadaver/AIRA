...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D D0–D7 **#53–#74 DONE**. Phase E Desktop **#75–#78 DONE**; **#79 OPEN** — [`docs/desktop-gui.md`](docs/desktop-gui.md), [`docs/desktop-launcher.md`](docs/desktop-launcher.md), [`docs/phase-e-plan.md`](docs/phase-e-plan.md).
