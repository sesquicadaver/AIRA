...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D D0–D4 **#53–#64 DONE**; Addendum D5 [`docs/phase-d-plan.md`](docs/phase-d-plan.md) §6b — наступний OPEN: **#65** (ModelShareOffer schema).
