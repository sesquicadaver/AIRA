...
**Черга задач:** [`QUEUE.md`](QUEUE.md) — Phase C **#38–#52 DONE**. Phase D D0–D7 **#53–#74 DONE**. Phase E Desktop **#75–#79 DONE**; Addendum E1.1 **#80 OPEN** — [`docs/phase-e-plan.md`](docs/phase-e-plan.md) §4a.
