...
#[cfg(test)]
pub use keyring::process_crypto_test_lock;
pub use keyring::{
    active_identity, active_signature, bind_thread_crypto, is_cryptographic_signature,
    ...
    register_node_identity, reset_primary_signer, set_primary_signer, sign_with_key, signature_for,
    unregister_verifying, verify_ed25519, Keyring, ThreadCryptoGuard,
};
