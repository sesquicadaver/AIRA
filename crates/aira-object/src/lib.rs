...
pub use crypto::{
    ...
    sign_with_key, signature_for, sync_trust_verifiers, utc_now_rfc3339, verify_ed25519,
    CryptoError, Keyring, RevokedEntry, TrustEntry, TrustStore, LOCAL_TEST_DOMAIN_MSG,
    LOCAL_TEST_KEY_REF,
};
