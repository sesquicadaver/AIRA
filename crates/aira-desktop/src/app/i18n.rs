...
static EN: Labels = Labels {
    ...
    sys_model_triple_hint: "Selected, ready, and used-in-result are independent — missing a model does not block built-in calculation.",
    ...
    peer_dial_hint: "Trusted peer + explicit dial address required. Completing setup alone is not a remote session; success stores handshake evidence without inventing DIRECT reachability.",
    dial_peer: "peer_id:",
    dial_addr: "dial_addr:",
    dial_run: "Dial",
...
static UK: Labels = Labels {
    ...
    sys_model_triple_hint: "Вибрана, готова й використана в результаті — незалежні факти. Відсутність моделі не блокує вбудовані обчислення.",
    ...
    peer_dial_hint: "Потрібні довірений peer і явна dial-адреса. Саме налаштування — не віддалена сесія; успіх зберігає evidence handshake без вигаданого DIRECT.",
    dial_peer: "peer_id:",
    dial_addr: "dial_addr:",
    dial_run: "Dial",
