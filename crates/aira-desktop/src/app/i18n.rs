...
static EN: Labels = Labels {
    ...
    help_placeholder: "Offline help articles arrive in a later Phase O atom. This panel only binds the stable help_id for the current context.",
    help_close: "Close",
...
static UK: Labels = Labels {
    ...
    help_placeholder: "Офлайн-статті довідки з’являться в наступних атомах Phase O. Ця панель лише прив’язує стабільний help_id поточного контексту.",
    help_close: "Закрити",
