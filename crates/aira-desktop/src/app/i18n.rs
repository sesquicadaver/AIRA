...
static EN: Labels = Labels {
    ...
    work_executor_hint: "Auto uses the Settings tip when available. Specific requires an available catalog model. Choice ≠ VERIFIED. Math does not need a model.",
...
static UK: Labels = Labels {
    ...
    work_executor_hint: "Авто бере tip з Параметри→Моделі, якщо доступний. Конкретна — доступна модель з каталогу. Вибір ≠ VERIFIED. Розрахунок не потребує моделі.",
