...
static EN: Labels = Labels {
    ...
    settings_models_observe_only: "Observe-only here — not an inventory editor. Activate models with `aira models` / documented tooling.",
...
static UK: Labels = Labels {
    ...
    settings_models_observe_only: "Лише спостереження — не редактор інвентаря. Активація через `aira models` / задокументований інструментарій.",
