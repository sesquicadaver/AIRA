...
pub struct Labels {
    ...
    pub settings_models_observe_only: &'static str,
...
static EN: Labels = Labels {
    ...
    settings_models_observe_only: "Local model select/activate belongs here (RFC-0159 amd. 2026-09-10). Triple selected ≠ ready ≠ used stays honest; choice ≠ VERIFIED. CLI `aira models` remains valid.",
...
static UK: Labels = Labels {
    ...
    settings_models_observe_only: "Тут має бути вибір/активація локальної моделі (RFC-0159, поправка 2026-09-10). Трійка selected ≠ ready ≠ used лишається чесною; вибір ≠ VERIFIED. CLI `aira models` лишається чинним.",
