...
static EN: Labels = Labels {
    ...
    settings_ollama_bound: "Ollama bind saved — restart node to apply process executor.",
...
static UK: Labels = Labels {
    ...
    settings_ollama_bound: "Прив’язку Ollama збережено — перезапустіть node для process executor.",
