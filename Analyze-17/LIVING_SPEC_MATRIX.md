# Living Spec Matrix — Analyze-17

| ID | Issue | Реалізація | Перевірка | Статус |
|----|-------|------------|-----------|--------|
| LS17-001 | #71 | `ProtocolEnvelope` + schemas | fixture valid/invalid | mapped |
| LS17-002 | #72 | `EventProtocolAdapter` | idempotent + UNSUPPORTED_VERSION | mapped |
