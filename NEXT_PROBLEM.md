...
**Active backlog:** [`QUEUE.md`](QUEUE.md) — Phase W [`docs/phase-w-plan.md`](docs/phase-w-plan.md) `#331`–`#342` **DONE** @ RFC-0215; **QUEUE W closed**; Phase X [`docs/phase-x-plan.md`](docs/phase-x-plan.md) `#343`–`#358` **IN PROGRESS** (Pack 2 GUI; `#343`–`#357` DONE; first OPEN `#358`; RFC-0226 reserved); Phase V [`docs/phase-v-plan.md`](docs/phase-v-plan.md) `#323`–`#330` **DONE** @ RFC-0208 (**QUEUE V closed**; [`docs/repair-package-1.md`](docs/repair-package-1.md)); Phase U [`docs/phase-u-plan.md`](docs/phase-u-plan.md) `#313`–`#322` **DONE** @ RFC-0198 (**QUEUE U closed**); Repair Pack 0 **DONE** @ [`docs/repair-package-0.md`](docs/repair-package-0.md) / RFC-0207 ([`product-requirements-trace.md`](docs/product-requirements-trace.md)); Phase T [`docs/phase-t-plan.md`](docs/phase-t-plan.md) `#306`–`#312` **DONE** @ RFC-0192 (**QUEUE T closed**); Phase S [`docs/phase-s-plan.md`](docs/phase-s-plan.md) `#295`–`#305` **DONE** @ RFC-0182 (**QUEUE S closed**); Phase R [`docs/phase-r-plan.md`](docs/phase-r-plan.md) `#286`–`#294` **DONE** @ RFC-0174 (**QUEUE R closed**); Phase Q `#275`–`#285` **DONE** @ RFC-0164 (**QUEUE Q closed**); Phase P **DONE** @ RFC-0156 (QUEUE P closed); Phase O **DONE** @ RFC-0146 (QUEUE O closed); **QUEUE N-fix closed** @ RFC-0139; QUEUE N closed @ RFC-0123; QUEUE M closed @ RFC-0117; QUEUE L closed @ RFC-0111
