...
- Активна лінійна черга — [`QUEUE.md`](QUEUE.md); виконання — **немає OPEN (audit `#376`–`#389` **DONE**)**. (Phase N `#231`–`#247` і `#232` — закритий provenance, не tip.)
