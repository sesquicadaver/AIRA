...
**Active backlog:** [`QUEUE.md`](QUEUE.md) Phase M `#224`–`#230` (перший OPEN = `#228`) — [`docs/phase-m-plan.md`](docs/phase-m-plan.md); QUEUE L closed @ RFC-0111  
...
- Активна лінійна черга — Phase M [`docs/phase-m-plan.md`](docs/phase-m-plan.md); виконання — перший OPEN `#228` у [`QUEUE.md`](QUEUE.md). QUEUE L closed.
