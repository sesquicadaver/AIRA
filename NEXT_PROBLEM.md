...
**Active backlog:** [`QUEUE.md`](QUEUE.md) Phase L `#217`–`#223` (перший OPEN = `#220`) — [`docs/phase-l-plan.md`](docs/phase-l-plan.md)  
...
- Активна лінійна черга — Phase L [`docs/phase-l-plan.md`](docs/phase-l-plan.md); виконання — перший OPEN `#220` у [`QUEUE.md`](QUEUE.md).
