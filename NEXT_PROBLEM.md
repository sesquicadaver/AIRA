...
**Active backlog:** [`QUEUE.md`](QUEUE.md) Phase L `#217`–`#223` (перший OPEN = `#222`) — [`docs/phase-l-plan.md`](docs/phase-l-plan.md)  
...
- Активна лінійна черга — Phase L [`docs/phase-l-plan.md`](docs/phase-l-plan.md); виконання — перший OPEN `#222` у [`QUEUE.md`](QUEUE.md).
