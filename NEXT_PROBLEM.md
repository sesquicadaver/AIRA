...
- Активна лінійна черга — [`QUEUE.md`](QUEUE.md); виконання — **перший OPEN `#388`**. (Phase N `#231`–`#247` і `#232` — закритий provenance, не tip.)
