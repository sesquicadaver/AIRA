...
**Active backlog (`#387` shared-tip rule):** [`QUEUE.md`](QUEUE.md) — **перший OPEN `#392`** (Phase Z remove how-it-works; [`docs/phase-z-plan.md`](docs/phase-z-plan.md); `#390`–`#391` DONE). Audit A `#376`–`#389` **DONE** (closed provenance). Phase Y `#359`–`#375` **DONE**; K `#376`–`#382` **DONE**; D `#383`–`#387` **DONE**. Closed provenance (not tip): Phase W [`docs/phase-w-plan.md`](docs/phase-w-plan.md) `#331`–`#342` **QUEUE W closed** @ RFC-0215; Phase X [`docs/phase-x-plan.md`](docs/phase-x-plan.md) `#343`–`#358` **QUEUE X closed** @ RFC-0226; Phase V [`docs/phase-v-plan.md`](docs/phase-v-plan.md) **QUEUE V closed** @ RFC-0208; Phase U [`docs/phase-u-plan.md`](docs/phase-u-plan.md) **QUEUE U closed** @ RFC-0198; Phase T [`docs/phase-t-plan.md`](docs/phase-t-plan.md) **QUEUE T closed** @ RFC-0192; Phase S [`docs/phase-s-plan.md`](docs/phase-s-plan.md) **QUEUE S closed** @ RFC-0182; Phase R [`docs/phase-r-plan.md`](docs/phase-r-plan.md) **QUEUE R closed** @ RFC-0174; Phase Q **QUEUE Q closed** @ RFC-0164; Phase P **QUEUE P closed** @ RFC-0156; Phase O [`docs/phase-o-plan.md`](docs/phase-o-plan.md) **QUEUE O closed** @ RFC-0146; **QUEUE N-fix closed** @ RFC-0139; **QUEUE N closed** @ RFC-0123; Phase M [`docs/phase-m-plan.md`](docs/phase-m-plan.md) **QUEUE M closed** @ RFC-0117; Phase L [`docs/phase-l-plan.md`](docs/phase-l-plan.md) **QUEUE L closed** @ RFC-0111.
...
- Активна лінійна черга — [`QUEUE.md`](QUEUE.md); виконання — **перший OPEN `#392`** ([`docs/phase-z-plan.md`](docs/phase-z-plan.md)). (Phase N `#231`–`#247` і `#232` — закритий provenance, не tip.)
