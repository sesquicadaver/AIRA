...
- Активна лінійна черга — [`QUEUE.md`](QUEUE.md); виконання — **перший OPEN `#391`** ([`docs/phase-z-plan.md`](docs/phase-z-plan.md)). (Phase N `#231`–`#247` і `#232` — закритий provenance, не tip.)
