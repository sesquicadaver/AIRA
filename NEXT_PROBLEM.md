...
**Active backlog:** [`QUEUE.md`](QUEUE.md) — **QUEUE U closed** @ RFC-0198; Repair Pack 0 **DONE** @ [`docs/repair-package-0.md`](docs/repair-package-0.md) / RFC-0207 (product contract); next engineering = Pack 1+ after phase-plan activation ([`product-requirements-trace.md`](docs/product-requirements-trace.md)). Phase T `#306`–`#312` **DONE** @ RFC-0192 (**QUEUE T closed**); Phase S `#295`–`#305` **DONE** @ RFC-0182 (**QUEUE S closed**); Phase R `#286`–`#294` **DONE** @ RFC-0174 (**QUEUE R closed**); Phase Q `#275`–`#285` **DONE** @ RFC-0164 (**QUEUE Q closed**); Phase P **DONE** @ RFC-0156 (QUEUE P closed); Phase O **DONE** @ RFC-0146 (QUEUE O closed); **QUEUE N-fix closed** @ RFC-0139; QUEUE N closed @ RFC-0123; QUEUE M closed @ RFC-0117; QUEUE L closed @ RFC-0111
