...
**Active backlog:** [`QUEUE.md`](QUEUE.md) Phase N `#231`–`#247` (перший OPEN = `#237`) — [`docs/phase-n-plan.md`](docs/phase-n-plan.md); QUEUE M closed @ RFC-0117; QUEUE L closed @ RFC-0111  
