...
**Active backlog:** [`QUEUE.md`](QUEUE.md) Phase M `#224`–`#230` **DONE** @ RFC-0117; QUEUE M closed; QUEUE L closed @ RFC-0111  
...
- Активна лінійна черга — Phase M [`docs/phase-m-plan.md`](docs/phase-m-plan.md) **DONE** @ RFC-0117; QUEUE M closed. QUEUE L closed.
